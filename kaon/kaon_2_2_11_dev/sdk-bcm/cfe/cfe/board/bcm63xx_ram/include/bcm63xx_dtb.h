...
int dtb_getprop_cma_rsvmem_size(int dtb_id, const char *node_name, uint64_t* size);
int dtb_setprop_cma_rsvmem_size(int dtb_id, const char *node_name, uint64_t size);
...
#if defined (_BCM96858_) || defined (_BCM94908_) || defined (_BCM963158_) || defined (_BCM96846_) || defined (_BCM96856_) || defined (_BCM963138_) || defined(_BCM963178_) || defined(_BCM947622_) || defined (_BCM96878_)

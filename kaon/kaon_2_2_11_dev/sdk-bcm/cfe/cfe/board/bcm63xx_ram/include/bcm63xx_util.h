...
#define AUXFS_SIZE_PROMPT    "Invalid auxillary file system size (0-255)"
...
#define BOOT_FILENAME_LEN   128	// "f=vmlinux"
...
extern void bcm63xx_run_ex(int breakIntoCfe, int chk_memcfg);
...
#if defined(_BCM94908_) || defined(_BCM96858_) || defined (_BCM963158_) || defined (_BCM96846_) || defined (_BCM96856_) || defined(_BCM963178_) || defined(_BCM947622_) || defined(_BCM96878_)
...
extern int getDtbFromTag(unsigned char* dtbBuf, unsigned int* size);
    ...
    defined (_BCM963178_) || defined (_BCM947622_)

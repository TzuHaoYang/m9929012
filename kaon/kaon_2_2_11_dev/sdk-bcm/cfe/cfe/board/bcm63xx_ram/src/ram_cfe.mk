...
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_4908_6858_63158_6846_6856_63178_47622_6878_),)
...
CFLAGS +=-DCFG_CROSSBAR -DSYSPORT_V1
endif
ifneq ($(findstring _$(strip $(BRCM_CHIP))_,_63158_47622_),)
CFLAGS +=-DCFG_DDR_TYPE_CHECK
endif
...
CFLAGS += -DCONFIG_BRCM_IKOS $(IKOS_CFLAGS)
endif

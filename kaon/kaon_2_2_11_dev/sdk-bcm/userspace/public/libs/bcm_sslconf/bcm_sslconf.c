...
void start_element(void *data, const char *element, const char **attribute __attribute__((unused)))
{
...
void char_data (void *data __attribute__((unused)), const XML_Char *s, int len)
{

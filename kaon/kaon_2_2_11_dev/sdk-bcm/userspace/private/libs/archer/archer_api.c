...
int archer_dpi_sq_port_set(int kbps)
{
    archer_dpi_arg_t arg;

    arg.cmd = ARCHER_SQ_CMD_PORT_SET;
    arg.min_kbps = kbps;

    return archer_cmd_send(ARCHER_IOC_DPI, (unsigned long)&arg);
}

int archer_dpi_sq_port_get(int *kbps_p)
{
    archer_dpi_arg_t arg;
    int ret;

    arg.cmd = ARCHER_SQ_CMD_PORT_GET;
...
int archer_dpi_sq_arbiter_set(archer_sq_arbiter_t arbiter)
{
    archer_dpi_arg_t arg;
...
int archer_dpi_sq_arbiter_get(archer_sq_arbiter_t *arbiter_p)
{
    archer_dpi_arg_t arg;
    int ret;

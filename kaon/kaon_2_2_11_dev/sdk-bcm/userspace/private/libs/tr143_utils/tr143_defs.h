...
typedef struct connectionResult
{
   ...
   unsigned int TestBytes;
   unsigned int TotalBytesReceivedBegin;
   unsigned int TotalBytesReceivedEnd;
   unsigned int TotalBytesSentBegin;
...
int ftpUploadDiag_r (connectionResult_t *result);
int ftpDownloadDiag_r (connectionResult_t *result);

int httpDownloadDiag (void);
int httpUploadDiag (void);
int httpDownloadDiag_r(connectionResult_t *result);
int httpUploadDiag_r(connectionResult_t *result);

...
#ifdef DMP_DEVICE2_ETHLAG_1
   strcpy(webVar->ethLagMode, cmsDal_getDefaultValue("ethLagMode"));
   strcpy(webVar->xmitHashPolicy, cmsDal_getDefaultValue("xmitHashPolicy"));
   strcpy(webVar->lacp_rate, cmsDal_getDefaultValue("lacp_rate"));

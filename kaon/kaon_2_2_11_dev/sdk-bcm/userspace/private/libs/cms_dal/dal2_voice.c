...
const char *cctk_trace_level_valid_string[] = { MDMVS_DEBUG, MDMVS_INFO, MDMVS_WARN, MDMVS_OFF, 0};
...
CmsRet dalVoice_SetDefaults( DAL_VOICE_PARMS *parms, char *value )
{
    ...
    for ( i = 0; i < spNum; i++ )
    {
        ...
        /* Set Voice Svc level params */
        {
            ...
            if ( CMSRET_SUCCESS == ret )
            {
                /* X_BROADCOM_COM_BoundIfName will be handled below */
...
#endif /* BRCM_PKTCBL_SUPPORT */
                {
                   ...
                   REPLACE_STRING_IF_NOT_EQUAL( obj->X_BROADCOM_COM_ModuleLogLevels, "" );
                   REPLACE_STRING_IF_NOT_EQUAL( obj->X_BROADCOM_COM_CCTKTraceLevel, MDMVS_OFF );
                   REPLACE_STRING_IF_NOT_EQUAL( obj->X_BROADCOM_COM_CCTKTraceGroup, MDMVS_NONE );
                }
...
#ifndef BRCM_PKTCBL_SUPPORT
        /* The following will trigger an RCL action */
        ...
        if( dalVoice_AddVoipProfile( &parmsList, &vpInst) == CMSRET_SUCCESS)
        {
            ...
            dalVoice_SetRtcpEnable( &parmsList, MDMVS_YES );
            dalVoice_SetRtcpInterval( &parmsList, "5000" );
            dalVoice_SetRtcpXrEnable( &parmsList, MDMVS_NO );
            dalVoice_SetRtcpXrPubRepAddr( &parmsList, "" );
            dalVoice_SetKeepAliveSetting( &parmsList, MDMVS_OFF );
            dalVoice_SetHeldMediaEnabled( &parmsList, "true" );
        }
        else
        {
        ...
        for( j = 0; j < numFxs; j++ )
        {
            ...
            dalVoice_SetCXNtfyTimeout( &parmsList, "5" );
            ...
            dalVoice_SetNfMWISubDuration( &parmsList, "86400" );
            dalVoice_SetNoAnsTODuration( &parmsList, "200" );
...
CmsRet dalVoice_GetRtcpXrEnabled(DAL_VOICE_PARMS *parms, char *enable, unsigned int length )
{
    ...
    GET_L2OBJ_PARAM_BOOL( parms->op[0], parms->op[1], X_BROADCOM_COM_RTCPXR_Enable, enable, length );
...
CmsRet dalVoice_SetRtcpXrEnable( DAL_VOICE_PARMS *parms, char *value )
{
    ...
    SET_L2OBJ_PARAM_BOOL( parms->op[0], parms->op[1], X_BROADCOM_COM_RTCPXR_Enable, value );
...
static CmsRet dalVoice_SetDefaultNetworkParams( DAL_VOICE_PARMS *parms )
{
   ...
   /* Get the IP family */
   dalVoice_GetIpFamily( parms, (char*)getVal, sizeof(getVal));
   if( !(cmsUtl_strcmp( getVal, MDMVS_IPV6 )) )
   {
       strcpy( getVal, ZERO_ADDRESS_IPV6);
   }
   else
   ...
   dalVoice_SetSipNetworkEnabled( parms, "Yes");
   dalVoice_SetSipUserAgentPort( parms, "5060");
   dalVoice_SetSipOutboundProxy( parms, getVal);
   dalVoice_SetSipOutboundProxyPort( parms, "5060");
   dalVoice_SetSipProxyServer( parms, getVal);
   dalVoice_SetSipProxyServerPort( parms, "5060");
   dalVoice_SetSipRegistrarServer( parms, getVal );
   dalVoice_SetSipRegistrarServerPort( parms, "5060");
   dalVoice_SetSipRegisterExpires( parms, "3600");
   dalVoice_SetSipSecDomainName( parms, "");
   dalVoice_SetSipSecProxyAddr( parms, getVal);
   dalVoice_SetSipSecProxyPort( parms, "5060");
   dalVoice_SetSipSecOutboundProxyAddr( parms, getVal);
   dalVoice_SetSipSecOutboundProxyPort( parms, "5060");
   dalVoice_SetSipSecRegistrarAddr( parms, getVal);
   dalVoice_SetSipSecRegistrarPort( parms, "5060");
   dalVoice_SetSipRegisterRetryInterval( parms, "20");
   dalVoice_SetSipConferencingURI( parms, "");
   dalVoice_SetSipConferencingOption( parms, MDMVS_LOCAL);
#ifdef BRCM_PKTCBL_SUPPORT
   dalVoice_SetSipDSCPMark( parms, "0");
#else  /* BRCM_PKTCBL_SUPPORT */
   dalVoice_SetSipDSCPMark( parms, "46");
#endif /* BRCM_PKTCBL_SUPPORT */
   dalVoice_SetSipFailoverEnable(parms, MDMVS_OFF);
   dalVoice_SetSipOptionsEnable(parms, MDMVS_OFF);
   dalVoice_SetSipBackToPrimOption(parms, MDMVS_DISABLED);
#ifdef BRCM_PKTCBL_SUPPORT
   dalVoice_SetSipMode( parms, MDMVS_IMS );
#else  /* BRCM_PKTCBL_SUPPORT */
   dalVoice_SetSipMode( parms, MDMVS_RFC3261 );
#endif /* BRCM_PKTCBL_SUPPORT */
   dalVoice_SetPCSCFMaxTime( parms, "1800" );
   dalVoice_SetPCSCFBaseTimeAllFailed( parms, "30" );
   dalVoice_SetPCSCFBaseTimeAllNotFailed( parms, "90" );
   dalVoice_SetTimerSubscriptionFailed( parms, "20" );  /* Set to 20 seconds, as this is the
                                                        ** default reg retry timer value.
                                                        */
...
{
    CmsRet ret = CMSRET_SUCCESS;
    GET_CALLING_FEATURES_PARAM_UINT( parms->op[0], parms->op[1], X_BROADCOM_COM_NfMWISubDuration, value, length);
    return ( ret );
}
...
{
    CmsRet ret = CMSRET_SUCCESS;
    SET_CALLING_FEATURES_PARAM_UINT( parms->op[0], parms->op[1], X_BROADCOM_COM_NfMWISubDuration, value, 0);
    return ret;
}

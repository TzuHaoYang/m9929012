...
typedef WlmdmRet (*set) (const char *nvname, const char *value);
typedef WlmdmRet (*get) (const char *nvname, char *value, size_t size);
typedef UBOOL8 (*match) (const char *nvname);
typedef WlmdmRet (*foreach) (nvc_for_each_func for_each_func, void *data);

...
int wlgetChannelList(const char *ifname, int band, int bandwidth,
                     const char *country, int chanList[], int size);


int wlgetStaionStats(const char* hwaddr, Station_Stats *stats);
#endif

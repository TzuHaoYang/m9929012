...
/* functions defined in cli_intfGroup.c */
void processIntfGroupCmd(char *cmdLine);

UINT32 cliIntfGroup_getNumberOfGroups(void);
UINT32 cliIntfGroup_getNumberOfGroups_igd(void);
UINT32 cliIntfGroup_getNumberOfGroups_dev2(void);

#if defined(SUPPORT_DM_LEGACY98)
#define cliIntfGroup_getNumberOfGroups()   cliIntfGroup_getNumberOfGroups_igd()
#elif defined(SUPPORT_DM_HYBRID)
#define cliIntfGroup_getNumberOfGroups()   cliIntfGroup_getNumberOfGroups_igd()
#elif defined(SUPPORT_DM_PURE181)
#define cliIntfGroup_getNumberOfGroups()   cliIntfGroup_getNumberOfGroups_dev2()
#elif defined(SUPPORT_DM_DETECT)
#define cliIntfGroup_getNumberOfGroups()   (cmsMdm_isDataModelDevice2() ? \
                                            cliIntfGroup_getNumberOfGroups_dev2() : \
                                            cliIntfGroup_getNumberOfGroups_igd()
#endif

void cliIntfGroup_getGroupInfo(UINT32 brIdx,
...
#if defined(SUPPORT_DM_LEGACY98)
#define cliIntfGroup_getGroupInfo(a, b, c, d, e, f, g, h, i, j)  cliIntfGroup_getGroupInfo_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j))
#elif defined(SUPPORT_DM_HYBRID)
#define cliIntfGroup_getGroupInfo(a, b, c, d, e, f, g, h, i, j)  cliIntfGroup_getGroupInfo_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j))
#elif defined(SUPPORT_DM_PURE181)
#define cliIntfGroup_getGroupInfo(a, b, c, d, e, f, g, h, i, j)  cliIntfGroup_getGroupInfo_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i), (j))
#elif defined(SUPPORT_DM_DETECT)
#define cliIntfGroup_getGroupInfo(a, b, c, d, e, f, g, h, i, j)  (cmsMdm_isDataModelDevice2() ? \
                                                                  cliIntfGroup_getGroupInfo_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i), (j)) : \
                                                                  cliIntfGroup_getGroupInfo_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j)))
#endif


void cliIntfGroup_getGroupInfoByName(const char *groupName,
             UINT32 *brIdx,
             char *intfList, UINT32 intfListLen, UINT32 *numIntf,
             char *wanIntfList, UINT32 wanIntfListLen, UINT32 *numWanIntf, char *wanIfName);
...
#if defined(SUPPORT_DM_LEGACY98)
#define cliIntfGroup_getGroupInfoByName(a, b, c, d, e, f, g, h, i)  cliIntfGroup_getGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i))
#elif defined(SUPPORT_DM_HYBRID)
#define cliIntfGroup_getGroupInfoByName(a, b, c, d, e, f, g, h, i)  cliIntfGroup_getGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i))
#elif defined(SUPPORT_DM_PURE181)
#define cliIntfGroup_getGroupInfoByName(a, b, c, d, e, f, g, h, i)  cliIntfGroup_getGroupInfoByName_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i))
#elif defined(SUPPORT_DM_DETECT)
#define cliIntfGroup_getGroupInfoByName(a, b, c, d, e, f, g, h, i)  (cmsMdm_isDataModelDevice2() ? \
                                                                     cliIntfGroup_getGroupInfoByName_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i)) : \
                                                                     cliIntfGroup_getGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i)))
#endif

UBOOL8 cliIntfGroup_isAvailableLanInterface(char *lanIfName);
...
#if defined(SUPPORT_DM_LEGACY98)
#define cliIntfGroup_isAvailableLanInterface(l)          cliIntfGroup_isAvailableLanInterface_igd((l))
#elif defined(SUPPORT_DM_HYBRID)
#define cliIntfGroup_isAvailableLanInterface(l)          cliIntfGroup_isAvailableLanInterface_igd((l))
#elif defined(SUPPORT_DM_PURE181)
#define cliIntfGroup_isAvailableLanInterface(l)          cliIntfGroup_isAvailableLanInterface_dev2((l))
#elif defined(SUPPORT_DM_DETECT)
#define cliIntfGroup_isAvailableLanInterface(l)          (cmsMdm_isDataModelDevice2() ? \
                                                          cliIntfGroup_isAvailableLanInterface_dev2((l)) : \
                                                          cliIntfGroup_isAvailableLanInterface_igd((l)))
#endif


UBOOL8 cliIntfGroup_isAvailableWanInterface(char *wanIfName);
...
#if defined(SUPPORT_DM_LEGACY98)
#define cliIntfGroup_isAvailableWanInterface(w)          cliIntfGroup_isAvailableWanInterface_igd((w))
#elif defined(SUPPORT_DM_HYBRID)
#define cliIntfGroup_isAvailableWanInterface(w)          cliIntfGroup_isAvailableWanInterface_igd((w))
#elif defined(SUPPORT_DM_PURE181)
#define cliIntfGroup_isAvailableWanInterface(w)          cliIntfGroup_isAvailableWanInterface_dev2((w))
#elif defined(SUPPORT_DM_DETECT)
#define cliIntfGroup_isAvailableWanInterface(w)          (cmsMdm_isDataModelDevice2() ? \
                                                          cliIntfGroup_isAvailableWanInterface_dev2((w)) : \
                                                          cliIntfGroup_isAvailableWanInterface_igd((w)))
#endif

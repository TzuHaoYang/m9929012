...
#else
CmsRet qdmIpIntf_getDefaultLanIntfNameLocked_dev2(char *ifName __attribute__((unused)))
{
   return CMSRET_OBJECT_NOT_FOUND;
}


CmsRet qdmIpIntf_getIpv4AddrAndSubnetByNameLocked_dev2(const char *ipIntfName __attribute__((unused)),
                                                       char *ipAddress __attribute__((unused)),
                                                       char *subnetMask __attribute__((unused)))
{
   return CMSRET_OBJECT_NOT_FOUND;
}

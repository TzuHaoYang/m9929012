     ...
     UINT32 *cpu3)
{
    ...
    float in3 = 0, in4 = 0, in5 = 0, in6 = 0, in7 = 0;
    float in8 = 0, in9 = 0, in10 = 0, in11 = 0, cpuidle = 0;
    UINT32 count = 0;
    FILE *fs = NULL;
    ...
    while ( fgets(line, sizeof(line), fs) )
    {
        ...
        sscanf(line, "%s %s %f %f %f %f %f %f %f %f %f %f",
               in1, in2, &in3, &in4, &in5, &in6,
               &in7, &in8, &in9, &in10, &in11, &cpuidle);

        switch (count)
        {
            case WSD_CPU_ALL_LINE:
                *cpu = (UINT32)(100 - cpuidle);
                break;
            case WSD_CPU_0_LINE:
                *cpu0 = (UINT32)(100 - cpuidle);
                break;
            case WSD_CPU_1_LINE:
                *cpu1 = (UINT32)(100 - cpuidle);
                break;
            case WSD_CPU_2_LINE:
                *cpu2 = (UINT32)(100 - cpuidle);
                break;
            case WSD_CPU_3_LINE:
                *cpu3 = (UINT32)(100 - cpuidle);
                break;
        }
    }

...
ps -ef | grep tee-supplicant > /data/process
ps -ef | grep teec_sec_key >> /data/process
...
sleep 2
echo "+-------------------------------------------------------+------------------------------------------------------+"
echo "|  - Files inside /data/tee                             |  - Files inside /data/linux                          |"
echo "+-------------------------------------------------------+------------------------------------------------------+"
print_directory
read -p "Press enter to continue ..."
clear_screen 50
echo "+--------------------------------------------------------------------------------------------------------------+"
echo "| Intrusion encryption test                                                                                    |"
echo "|  - A second process is started to perform encryption with the keys owned by the first process                |"
echo "+-------------------------------------------------------+------------------------------------------------------+"
echo "| In OPTEE                                              | In Linux                                             |"
echo "|  - Only the authorised process (first to connect)     |  - The key and IV may be leaked from the process     |"
echo "|    can make use of secure key                         |                                                      |"
echo "|  - (newer)teec_sec_key -enc -in plaintext.txt         |  - openssl enc -in plaintext.txt -K 5D4140...        |"
echo "|                                           -k keyref1  |                                                      |"
echo "| Result                                                | Result                                               |"
echo "|  - TA: Security violation detected                    |  - ciphertext inside linux/ciphertext.bin.           |"
echo "+-------------------------------------------------------+------------------------------------------------------+"
echo "|  - Starting a second teec_sec_key process                                                                    |"
echo "+--------------------------------------------------------------------------------------------------------------+"
/bin/teec_sec_key &
sleep 2
echo " pid                      command"
echo " ===                      ======="
ps -ef | grep teec_sec_key
echo " "
echo "|                              NOTE: Only the first process will get the service                               |"
echo "+--------------------------------------------------------------------------------------------------------------+"
read -p "Press enter to continue ..."
clear_screen 50
echo "+--------------------------------------------------------------------------------------------------------------+"
echo "|  - New process trying to Encrypt /data/plaintext.txt using the same keyref1 key                              |"
echo "|                                                                                                              |"
echo "|    (newer)teec_sec_key -enc -in plaintext.txt -k keyref1                                                     |"
echo "+--------------------------------------------------------------------------------------------------------------+"
sleep 1
echo "7 aes_key1 /data/plaintext /data/tee/tryciphertext.bin" > /data/sec_fifo1
sleep 1
echo " "
read -p "Press enter to END ..."
echo "0" > /data/sec_fifo
sleep 1
# Find all the process that needs to be killed
ps -ef | grep tee-supplicant > /data/process
ps -ef | grep teec_sec_key >> /data/process

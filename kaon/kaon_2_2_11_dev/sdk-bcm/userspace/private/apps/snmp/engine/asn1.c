    ...
    register int intsize;    /* IN - size of *intp */
{
    ...
    /* Masking code below is removed as it does not handle unsigned long integers properly, 
     *  which may be full range 0..0xFFFF FFFF and should NOT be masked out 
     *  SNMP protocol behaviour is not affected.
     */
#if 0

...
int main(int argc, char** argv)
{
   ...
   if (0 == cmsUtl_strcmp(obj->IPVersion, MDMVS_IPV4))
   {
      snmpTransportIpVer = 1 << SNMPTRANSPORTIPVERBITS_IPV4;
   }
   else if (0 == cmsUtl_strcmp(obj->IPVersion, MDMVS_IPV6))
   {
      snmpTransportIpVer = 1 << SNMPTRANSPORTIPVERBITS_IPV6;
   }
   else if (0 == cmsUtl_strcmp(obj->IPVersion, MDMVS_IPV4V6))
   {
      snmpTransportIpVer = 1 << SNMPTRANSPORTIPVERBITS_IPV4
                           | 1 << SNMPTRANSPORTIPVERBITS_IPV6;
   }
...
int sendStartTrap(int trapCode)
{
    ...
    cmsLog_notice("Sending start trap type %d", trapCode);

...
void cgiGetConfiguredEthWanIntf(int argc __attribute__((unused)), char **argv __attribute__((unused)), char *varValue) ;
...
/** Helper function to display configured ethLag interfaces.
 *
 */
void cgiEthLagCfg(char *path, FILE *fs);

#if 0
UBOOL8 cgiEthLagCfg_igd(FILE *fs);
UBOOL8 cgiEthLagCfg_dev2(FILE *fs);

#if defined(SUPPORT_DM_LEGACY98)
#define cgiEthLagCfg(p)   cgiEthLagCfg_igd((p))
#elif defined(SUPPORT_DM_HYBRID)
#define cgiEthLagCfg(p)   cgiEthLagCfg_igd((p))
#elif defined(SUPPORT_DM_PURE181)
#define cgiEthLagCfg(p)   cgiEthLagCfg_dev2((p))
#elif defined(SUPPORT_DM_DETECT)
#define cgiEthLagCfg(p)   (cmsMdm_isDataModelDevice2() ? \
                              cgiEthLagCfg_dev2((p)) :   \
                              cgiEthLagCfg_igd((p)))
#endif
...
void cgiGetUiWanUpStreamMode(int argc, char **argv, char *varValue);
#endif
...
extern void cgiBuildWlDpdCtl(int argc __attribute__((unused)), char **argv __attribute__((unused)), char *varValue);
...
#if defined(BCM_PON)
void cgiWanSelectData(int argc, char **argv, char *varValue);
#endif

...
/** Get info associated with this interface group name.
 *
 * @param groupName (IN) The interface group name.
 */
void cgiGetIntfGroupInfoByName(const char *groupName,
             UINT32 *brIdx,
             char *intfList, UINT32 intfListLen, UINT32 *numIntf,
             char *wanIntfList, UINT32 wanIntfListLen, UINT32 *numWanIntf, char *wanIfName,
             char *vendorIdList, UINT32 vendorIdListLen, UINT32 *numVendorIds);

void cgiGetIntfGroupInfoByName_igd(const char *groupName,
             UINT32 *brIdx,
             char *intfList, UINT32 intfListLen, UINT32 *numIntf,
             char *wanIntfList, UINT32 wanIntfListLen, UINT32 *numWanIntf, char *wanIfName,
             char *vendorIdList, UINT32 vendorIdListLen, UINT32 *numVendorIds);

void cgiGetIntfGroupInfoByName_dev2(const char *groupName,
             UINT32 *brIdx,
             char *intfList, UINT32 intfListLen, UINT32 *numIntf,
             char *wanIntfList, UINT32 wanIntfListLen, UINT32 *numWanIntf, char *wanIfName,
             char *vendorIdList, UINT32 vendorIdListLen, UINT32 *numVendorIds);
...
#if defined(SUPPORT_DM_LEGACY98)
#define cgiGetIntfGroupInfoByName(a, b, c, d, e, f, g, h, i, j, k, l)  cgiGetIntfGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l))
#elif defined(SUPPORT_DM_HYBRID)
#define cgiGetIntfGroupInfoByName(a, b, c, d, e, f, g, h, i, j, k, l)  cgiGetIntfGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l))
#elif defined(SUPPORT_DM_PURE181)
#define cgiGetIntfGroupInfoByName(a, b, c, d, e, f, g, h, i, j, k, l)  cgiGetIntfGroupInfoByName_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l))
#elif defined(SUPPORT_DM_DETECT)
#define cgiGetIntfGroupInfoByName(a, b, c, d, e, f, g, h, i, j, k, l)  (cmsMdm_isDataModelDevice2() ? \
                  cgiGetIntfGroupInfoByName_dev2((a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l)) : \
                  cgiGetIntfGroupInfoByName_igd((a), (b), (c), (d), (e), (f), (g), (h), (i), (j), (k), (l)))
#endif

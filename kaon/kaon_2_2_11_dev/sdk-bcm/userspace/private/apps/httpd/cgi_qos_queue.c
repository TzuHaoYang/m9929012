...
#endif
#if defined(SUPPORT_FAPCTL) || defined(SUPPORT_RDPA) || defined(SUPPORT_ARCHERCTL)
   fprintf(fs, "      <td class='hd'>DropAlg/ LoMin/LoMax/HiMin/HiMax</td>\n");
#endif
#if defined(SUPPORT_DSL) || defined(SUPPORT_FAPCTL) || defined(SUPPORT_RDPA) || defined(SUPPORT_BCMTM)
      ...
      for (i = 1; i <= maxLevel; i++)
      {
         ...
         else
         {
            ...
            else if (rddTmEth)
            {
               ...
               {
#if defined(SUPPORT_RDPA) && !defined(BCM_PON)
                  if (numSP > 4 ||

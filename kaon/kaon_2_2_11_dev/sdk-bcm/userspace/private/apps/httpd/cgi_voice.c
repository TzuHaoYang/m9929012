...
static SIP_PARM_TABLE sipParmTable[] =
{
   ...
   { "voiceDnsEnable",  0,    FALSE,    FALSE,      "",      dalVoice_GetVoiceDnsEnable,                  dalVoice_SetVoiceDnsEnable          },
   { "voiceDnsAddrPri", 0,    FALSE,    FALSE,      "",      dalVoice_GetDnsServerAddrPri,                dalVoice_SetDnsServerAddrPri        },
   { "voiceDnsAddrSec", 0,    FALSE,    FALSE,      "",      dalVoice_GetDnsServerAddrSec,                dalVoice_SetDnsServerAddrSec        },
...
/* Used even if NTR support is off to find out if NTR webpage should be displayed */
...
#ifdef SIPLOAD
   { "sipMode",         1,    FALSE,    TRUE,       "smode", dalVoice_GetSipMode,                         dalVoice_SetSipMode                 },
   ...
   { "callIdNumber",    2,    TRUE,     TRUE,       "cidnum",dalVoice_GetVlCFCallId,                      dalVoice_SetVlCFCallId              },
   { "callIdName",      2,    TRUE,     TRUE,       "cidname",dalVoice_GetVlCFCallIdName,                 dalVoice_SetVlCFCallIdName          },
   ...
   { "hookFlashRelay",  1,    FALSE,    TRUE,      "hr",     dalVoice_GetHookFlashMethod,                 dalVoice_SetHookFlashMethod         },
   ...
   { "enblSipUriForTls",1,    FALSE,    TRUE,      "sipUriTls", dalVoice_GetSipUriForTls,                 dalVoice_SetSipUriForTls            },

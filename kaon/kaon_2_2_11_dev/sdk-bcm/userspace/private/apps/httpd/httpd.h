...
extern UBOOL8 glbWlRestartNeeded;
extern UBOOL8 glbNvramCommitNeeded;
...
extern void do_ntpd_cgi(char *path, FILE *stream);
#endif
...
extern struct cpe_mime_handler ignore_handler;
struct ej_handler {
	    char *pattern;
...
#define WEB_UPLOAD_IMAGE           (1)
#define WEB_UPLOAD_SETTINGS        (2)
#define WEB_PMD_UPLOAD_CALIBRATION (3)
#define WEB_PMD_UPLOAD_TEMP2APD    (4)
#define WEB_PMD_UPLOAD_JSON        (5)

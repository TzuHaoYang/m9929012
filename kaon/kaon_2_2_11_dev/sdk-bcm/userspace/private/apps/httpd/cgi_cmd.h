...
void cgiBackupPmdJson(char *path, FILE *fs);
void cgiBackupPmdCalibration(char *path, FILE *fs);
void cgiBackupPmdTemp2Apd(char *path, FILE *fs);
...
void cgiWanSelect(char *query, FILE *fs);
#endif

...
void cgiGetOpticalLinkStatus(int argc, char **argv, char *varValue);
void cgiGetGponUpstreamFec(int argc, char **argv, char *varValue);
void cgiGetGponDownstreamFec(int argc, char **argv, char *varValue);
#endif

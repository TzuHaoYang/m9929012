...
/*  the extended entity map struct
 *  stdOid - the standard Oid
 *  eeOid - the extended Oid
 */
typedef struct _sOidMap
{
    MdmObjectId stdOid;
    MdmObjectId eeOid;
}sOidMap;
...
typedef enum {
   ...
   rpcAutonDuStateChangeCompleteResponse,
} eRPCMethods;
...
/* keep this due to bcmWrapperDbus.c still uses it instead of tr69c_getScratchPadKey() */
#define VENDOR_CFG_INFO_TOKEN     "vendorCfg"


/* TR69C scratch-pad keys */
/* for EID_TR69C */
#define SPK_TR69C_1_TRANSFER            "tr69c_transfer"
#define SPK_TR69C_1_ACSSTATE            "tr69c_acsState"
#define SPK_TR69C_1_VENDOR_CFG_TOKEN    "vendorCfg"

/* for EID_TR69C_2 */
/* Note: the scratch-pad allowed max token name len is 15 */
#define SPK_TR69C_2_TRANSFER            "tr69c_transfer2"
#define SPK_TR69C_2_ACSSTATE            "tr69c_acsState2"
#define SPK_TR69C_2_VENDOR_CFG_TOKEN    "vendorCfg2"


#define INVALID_MAX_RPC_METHOD (LAST_RPC_METHOD + 1)
...
typedef struct ChangeDuStateOpReqInfo
{
   ...
   LIST_TYPE du_resp_list; /* only used for legacy tr69c */
   UINT32 numDuResp; /* only used for dbus tr69c */
   DUresponseStateChangedMsgBody *duResp; /* only used for dbus tr69c */
} ChangeDuStateOpReqInfo;

typedef struct DuResponseStateChangedEntry
{
   UINT16 num_of_du;
   DUresponseStateChangedMsgBody *du_list;
} DuResponseStateChangedEntry;
...
typedef enum {
   SPKT_ACSSTATE, /* tr69c_acsState */
   SPKT_TRANSFER, /* tr69c_transfer */
   SPKT_VENDOR_CFG_TOKEN /* vendorCfg */
} eScratchPadKeyType;

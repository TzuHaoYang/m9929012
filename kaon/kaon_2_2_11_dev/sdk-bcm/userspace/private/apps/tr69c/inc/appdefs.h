...
/** A longer MDM acquire lock timeout to be used during bootup.
 *
 * The system may have more locking activity during bootup, so wait longer
 * to ensure we can read the connectionRequestAuthentication param.
 */
#define TR69C_BOOTUP_LOCK_TIMEOUT (30*MSECS_IN_SEC)

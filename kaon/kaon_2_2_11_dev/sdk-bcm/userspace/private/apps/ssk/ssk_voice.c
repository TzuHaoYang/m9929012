 ...
 * This function handles the voice cmgr restart message 
 */
void processVoiceRestartCmgr(void)
{
   cmsLog_notice("voice cmgr restart requested");
...
/** processVoiceReboot()
 * This function handles the voice reboot message */
void processVoiceReboot(void)
{
   cmsLog_notice("voice reboot requested");
...
void initializeVoice(void)
{
   ...
   system("echo 60 > /proc/sys/kernel/watchdog_thresh");
#endif 

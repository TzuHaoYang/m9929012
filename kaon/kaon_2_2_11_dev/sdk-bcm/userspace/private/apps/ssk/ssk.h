 ...
 */
#define SSK_LINK_LOCK_WARNTHRESH (9*MSECS_IN_SEC)
...
/** Push the various ACS2 related params that we received via DHCP into
 * the data model object.
 */
void setAcs2Params(const char *acsURL, const char *provisioningCode,
                       UINT32 minWaitInterval, UINT32 intervalMultiplier);
void setAcs2Params_igd(const char *acsURL, const char *provisioningCode,
                       UINT32 minWaitInterval, UINT32 intervalMultiplier);
void setAcs2Params_dev2(const char *acsURL, const char *provisioningCode,
                       UINT32 minWaitInterval, UINT32 intervalMultiplier);

#if defined(SUPPORT_DM_LEGACY98)
#define setAcs2Params(u, p, w, m)    setAcs2Params_igd((u), (p), (w), (m))
#elif defined(SUPPORT_DM_HYBRID)
#define setAcs2Params(u, p, w, m)    setAcs2Params_igd((u), (p), (w), (m))
#elif defined(SUPPORT_DM_PURE181)
#define setAcs2Params(u, p, w, m)    setAcs2Params_dev2((u), (p), (w), (m))
#elif defined(SUPPORT_DM_DETECT)
#define setAcs2Params(u, p, w, m)    (cmsMdm_isDataModelDevice2() ? \
                                    setAcs2Params_dev2((u), (p), (w), (m)) : \
                                    setAcs2Params_igd((u), (p), (w), (m)))
#endif
...
void processVoiceRestartCmgr(void);
void processVoiceReboot(void);
...
void processAssociatedDeviceUpdated(CmsMsgHeader *msg);
...
#if defined(SUPPORT_DM_LEGACY98)
#define processAssociatedDeviceUpdated(m)  processAssociatedDeviceUpdated_igd((m))
#elif defined(SUPPORT_DM_HYBRID)
#define processAssociatedDeviceUpdated(m)  processAssociatedDeviceUpdated_igd((m))
#elif defined(SUPPORT_DM_PURE181)
#define processAssociatedDeviceUpdated(m)  processAssociatedDeviceUpdated_dev2((m))
#elif defined(SUPPORT_DM_DETECT)
#define processAssociatedDeviceUpdated(m)  (cmsMdm_isDataModelDevice2() ? \
                                     processAssociatedDeviceUpdated_dev2((m)) : \
                                     processAssociatedDeviceUpdated_igd((m)))
#endif
#endif

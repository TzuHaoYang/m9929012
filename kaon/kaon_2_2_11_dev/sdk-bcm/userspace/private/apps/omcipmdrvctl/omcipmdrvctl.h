...
/*
 *******************************************************************************
 * File Name  : omcipmdrvctl.h
 * Description: Command line parsing for the Broadcom OMCI PM To Drivers
 *              Control Utility
 *******************************************************************************
 */
...
typedef enum {
    OMCIPMDRVCTL_SUCCESS=0,
    OMCIPMDRVCTL_GENERAL_ERROR,
    OMCIPMDRVCTL_NOT_FOUND,
    OMCIPMDRVCTL_ALLOC_ERROR,
    OMCIPMDRVCTL_INVALID_COMMAND,
    OMCIPMDRVCTL_INVALID_OPTION,
    OMCIPMDRVCTL_INVALID_PARAMETER,
    OMCIPMDRVCTL_INVALID_NUMBER_OF_OPTIONS,
    OMCIPMDRVCTL_INVALID_NUMBER_OF_PARAMETERS
} omcipmdrvCtl_cmd_t;

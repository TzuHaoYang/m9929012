 ...
 *              BCM968xx Performance Monitoring Driver.
 ***************************************************************************/
...
char g_PgmName[MAX_PGM_NAME_LEN] = {0};
 ...
 *------------------------------------------------------------------------------
 */
static int getFecCountersHandler(POPTION_INFO pOptions __attribute__((unused)), int nNumOptions __attribute__((unused)))
{
    int ret = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getGemPortCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getGalEnetCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getEnetCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getEnet2CountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getEnet3CountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getEnetDnCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
    BCM_OMCI_PM_ETHERNET_UPDN_COUNTER64 counters;
    ...
    if (ret == OMCI_PM_STATUS_SUCCESS)
    {
        ...
        printf("   Drop Events         : %"PRIu64"\n", counters.dropEvents);
        printf("   Octets              : %"PRIu64"\n", counters.octets);
        printf("   Packets             : %"PRIu64"\n", counters.packets);
        printf("   Broadcast Packets   : %"PRIu64"\n", counters.broadcastPackets);
        printf("   Multicast Packets   : %"PRIu64"\n", counters.multicastPackets);
        printf("   CRC Errored Packets : %"PRIu64"\n", counters.crcErroredPackets);
        printf("   Undersize Packets   : %"PRIu64"\n", counters.undersizePackets);
        printf("   Oversize Packets    : %"PRIu64"\n", counters.oversizePackets);
        printf("   Packets64Octets     : %"PRIu64"\n", counters.packets64Octets);
        printf("   Packets127Octets    : %"PRIu64"\n", counters.packets127Octets);
        printf("   Packets255Octets    : %"PRIu64"\n", counters.packets255Octets);
        printf("   Packets511Octets    : %"PRIu64"\n", counters.packets511Octets);
        printf("   Packets1023ctets    : %"PRIu64"\n", counters.packets1023Octets);
        printf("   Packets1518Octets   : %"PRIu64"\n", counters.packets1518Octets);
        printf("\n=============================================\n\n");
    }
 ...
 *------------------------------------------------------------------------------
 */
static int getEnetUpCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
    BCM_OMCI_PM_ETHERNET_UPDN_COUNTER64 counters;
 ...
 *------------------------------------------------------------------------------
 */
static int getBridgeCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getBridgePortCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getMocaEnetCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getMocaIntfCountersHandler(POPTION_INFO pOptions __attribute__((unused)), int nNumOptions __attribute__((unused)))
{
    int ret = 0;
 ...
 *------------------------------------------------------------------------------
 */
static int getMocaIntfEntryCountersHandler(POPTION_INFO pOptions, int nNumOptions __attribute__((unused)))
{
    int ret = 0, portId = 0;
    BCM_OMCI_PM_MOCA_INTERFACE_COUNTER counters;

...
#ifndef _IEEE1905_PACKET_H_
#define _IEEE1905_PACKET_H_
...
#define I5_PROTO 0x893A
#define I5_MESSAGE_VERSION 0x00
#define I5_PACKET_BUF_LEN ETH_FRAME_LEN
...
typedef struct {
  ...
  unsigned char *pbuf;
  unsigned int length;
  unsigned int offset; // When reading
} i5_packet_type;

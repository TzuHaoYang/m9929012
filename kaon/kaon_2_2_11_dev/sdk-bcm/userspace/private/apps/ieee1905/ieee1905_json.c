...
#if 0  // use this code to send device friendly ip
    const char ipField[] = ",\"deviceFriendlyIp\":\"192.168.1.1\"";
    rc = _sock_printf(client, "{\"an\":{\"Dev-" I5_MAC_FMT "\":{\"label\":\"%s\",\"Type\":\"1\"%s}}}\r", 
              I5_MAC_PRM(device->DeviceId), device->friendlyName, ipField);
#else

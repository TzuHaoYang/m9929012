...
static inline int i5_cpy_host16_to_netbuf(unsigned char *dst, unsigned short src)
{ 
  dst[0] = (src >> 8) & 0xFF;
  dst[1] = (src >> 0) & 0xFF;
  return 2;
...
static inline int i5_cpy_host32_to_netbuf(unsigned char *dst, unsigned int src)
{ 
  dst[0] = (src >> 24) & 0xFF;
  dst[1] = (src >> 16) & 0xFF;
  dst[2] = (src >>  8) & 0xFF;
...
static inline int i5_cpy_netbuf_to_host16(unsigned short *dst, unsigned char *src)
{ 
  *dst = (src[0] << 8) | src[1];
  return 2;
}

static inline int i5_cpy_netbuf_to_host32(unsigned int *dst, unsigned char *src)
{ 

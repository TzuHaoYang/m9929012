...
char mcpd_igmp_upstream_interface[MCPD_MAX_IFS][IFNAMSIZ * 2 + 1];
char mcpd_igmp_mcast_interface[MCPD_MAX_IFS][IFNAMSIZ * 2 + 1];
unsigned int mcpd_igmp_upstream_interface_root_index[MCPD_MAX_IFS];
#else
...
#ifdef SUPPORT_MLD
#ifdef SUPPORT_OVS_BRIDGE_WAN_MCAST
char mcpd_mld_upstream_interface[MCPD_MAX_IFS][IFNAMSIZ * 2 + 1];
char mcpd_mld_mcast_interface[MCPD_MAX_IFS][IFNAMSIZ * 2 + 1];
unsigned int mcpd_mld_upstream_interface_root_index[MCPD_MAX_IFS];
#else

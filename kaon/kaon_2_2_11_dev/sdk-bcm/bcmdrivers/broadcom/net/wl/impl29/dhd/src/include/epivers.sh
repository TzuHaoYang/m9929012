...
#
# $Id: epivers.sh 640155 2016-05-26 10:51:00Z $
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: svn://bcawlansvn-lvn-01.lvn.broadcom.net/svn/bcawlan/proj/tags/DHD/DHD_REL_1_363_45_91037/src/include/epivers.sh $'

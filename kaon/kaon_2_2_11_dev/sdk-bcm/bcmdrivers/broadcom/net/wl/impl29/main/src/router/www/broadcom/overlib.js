...
// DSLCPE function to show/hide HND header
function show_hide_header(hide_header) {
	var page_header=document.getElementById("page_header");
	var page_title=document.getElementById("page_title");
	var bcaHideElements=document.getElementsByClassName("bca_cpe_hide");
	if(page_header!=null && page_title!=null) {
		if(hide_header == "1" || hide_header == "y" ) {
			if(page_header.style.display!="none") {
				page_header.style.display = "none";
				page_title.style.display = "inline";
			}
			for (var i = 0; i < bcaHideElements.length; i++) {
				bcaHideElements[i].style.display = "none";
			}
		} else {
			if(page_header.style.display!="inline") {
				page_header.style.display = "inline";
				page_title.style.display = "none";
			}
			for (var i = 0; i < bcaHideElements.length; i++) {
				bcaHideElements[i].style.display = "inline";
			}
		}
	}

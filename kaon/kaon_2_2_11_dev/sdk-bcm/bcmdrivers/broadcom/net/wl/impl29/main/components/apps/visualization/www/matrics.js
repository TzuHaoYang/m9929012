 ...
 *
 * $Id: matrics.js 682076 2017-01-31 10:13:15Z spalanga $
 */
...
function initPage()
{
	if (isHTTPDWebserver == 1) {
		...
		urlremotesettings = window.location.protocol + '//localhost/remotesettings.php';
		urlapstainfo = window.location.protocol + '//localhost/stationdetails.php';
		urlglitchcounter = window.location.protocol + '//localhost/Matrics.php';
		urlpacketqueuestats = window.location.protocol + '//localhost/Matrics.php';
		urlampdu = window.location.protocol + '//localhost/Matrics.php';
	}

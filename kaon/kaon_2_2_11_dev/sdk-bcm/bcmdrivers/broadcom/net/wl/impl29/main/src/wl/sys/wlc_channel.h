 ...
 *
 * $Id: wlc_channel.h 772104 2019-02-14 08:55:15Z $
 */
...
enum {
	...
	DLOAD_STATUS_CAL_TXINVALIDCHIPID = 15,
	DLOAD_STATUS_CAL_TXWRONGCHIPID = 16,
...
#ifdef WLC_TXCAL
extern dload_error_status_t wlc_handle_cal_dload(struct wlc_info *wlc,
	wlc_blob_segment_t *segments, uint32 segment_count);
extern int wlc_handle_cal_dump(struct wlc_info *wlc, void *buf, int len);
#endif /* WLC_TXCAL */
#ifdef WL_GLOBAL_RCLASS
extern bool wlc_sta_supports_global_rclass(wlc_info_t *wlc, uint8 *setBitBuff, uint8* flag);

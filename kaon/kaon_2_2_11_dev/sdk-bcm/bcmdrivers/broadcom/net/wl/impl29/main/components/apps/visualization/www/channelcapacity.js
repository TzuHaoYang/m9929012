 ...
 *
 * $Id: channelcapacity.js 682076 2017-01-31 10:13:15Z spalanga $
 */
...
function initPage()
{
	if (isHTTPDWebserver == 1) {
		...
		urlchcapacity = window.location.protocol + '//localhost/channelcapacity.php';
		urlapstainfo = window.location.protocol + '//localhost/stationdetails.php';
		urlselectedstainfodtls = window.location.protocol +'//localhost/stainfo.php';
	}

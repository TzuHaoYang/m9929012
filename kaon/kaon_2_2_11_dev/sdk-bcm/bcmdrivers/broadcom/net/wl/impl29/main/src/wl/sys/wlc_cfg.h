 ...
 *
 * $Id: wlc_cfg.h 610114 2016-01-06 07:22:30Z $
 */
...
#define ACPHY_DEFAULT		0x0f06f9ff      /* Supported acphy revs:
						 *
						 *
						 *
						 *
						 ...
						 *      25      4347TC2a0
						 */
#define ACPHY_DEFAULT2		0x00000000
...
#if defined(DONGLEBUILD) && defined(BCMDBG_ERR) && defined(ERR_USE_EVENT_LOG)
#if !defined(EVENT_LOG_COMPILE) || !defined(LOGTRACE)
#error "ERR_USE_EVENT_LOG requires LOGTRACE and EVENT_LOG_COMPILE"
#endif // endif
#endif /* DONGLEBUILD && BCMDBG_ERR && ERR_USE_EVENT_LOG */
...
#error "No MAC revisions configured!"
	...
	!LCN40CONF && !ACCONF && !LCN20CONF && !ACCONF2
...
#ifdef WLRSDB
#define RSDB_NOTIF_SRVR_OBJS	1
#define RSDB_NOTIF_CLNT_OBJS	8
#else
...
#define MAX_NOTIF_SERVERS	(20+IDSUP_NOTIF_SRVR_OBJS + RSDB_NOTIF_SRVR_OBJS + \
	PROXD_NOTIF_SRVR_OBJS)
#endif // endif

/* Maximum number of notification clients. */
#ifndef MAX_NOTIF_CLIENTS
#define MAX_NOTIF_CLIENTS	(36+IDSUP_NOTIF_CLNT_OBJS + RSDB_NOTIF_CLNT_OBJS + \

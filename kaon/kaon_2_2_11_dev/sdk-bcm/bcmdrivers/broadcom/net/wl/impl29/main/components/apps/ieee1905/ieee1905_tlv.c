...
int i5TlvAPCapabilitiesTypeExtract(i5_message_type *pmsg)
{
  i5_dm_device_type *pdevice;
  unsigned char *pvalue;
  unsigned int length;
...
int i5TlvAPRadioBasicCapabilitiesTypeExtract(i5_message_type *pmsg)
{
  i5_dm_device_type *pdevice;
  i5_dm_interface_type *pdmif;
  unsigned char *pvalue, mac[MAC_ADDR_LEN];
...
int i5TlvAPHTCapabilitiesTypeExtract(i5_message_type *pmsg)
{
  i5_dm_device_type *pdevice;
  i5_dm_interface_type *pdmif;
  unsigned char *pvalue, mac[MAC_ADDR_LEN];
...
int i5TlvAPVHTCapabilitiesTypeExtract(i5_message_type *pmsg)
{
  i5_dm_device_type *pdevice;
  i5_dm_interface_type *pdmif;
  unsigned char *pvalue, mac[MAC_ADDR_LEN];
...
int i5TlvAPHECapabilitiesTypeInsert(i5_message_type *pmsg, unsigned char *mac)
{
  unsigned char *pbuf, *pmem;
  i5_tlv_t *ptlv;
  int rc = 0;
...
int i5TlvAPHECapabilitiesTypeExtract(i5_message_type *pmsg, unsigned char *mac)
{
  unsigned char *pvalue;
  unsigned int length;

  if (i5MessageTlvExtract(pmsg, i5TlvAPHECapabilitiesType, &length, &pvalue, i5MessageTlvExtractWithReset) == 0) {
    if (length >= 1) {
      memcpy(mac, pvalue, MAC_ADDR_LEN);
      pvalue += MAC_ADDR_LEN;
      return 0;

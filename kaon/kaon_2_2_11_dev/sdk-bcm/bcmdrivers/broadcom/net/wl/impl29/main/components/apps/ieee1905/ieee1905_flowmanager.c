...
void i5FlowManagerActivateInterface(i5_socket_type *pif)
{
  ...
  unsigned short mediaType = i5GlueInterfaceGetMediaInfoFromName(pif->u.sll.ifname, NULL, NULL, NULL, NULL, NULL, NULL, 0);
...
static int i5FlowManagerGetPlcCost(unsigned int *plcCost)
{
  ...
  while ( pif ) {
    if ( pif->type == i5_socket_type_ll ) {
      ...
      unsigned short mediaType = i5GlueInterfaceGetMediaInfoFromName(pif->u.sll.ifname, NULL, NULL, netTechOui, NULL, NULL, NULL, 0);
...
static void i5FlowManagerUpdateStp(i5_socket_type *pFailedSock)
{
  ...
  if( pFailedSock != NULL ) {
    mediaType = i5GlueInterfaceGetMediaInfoFromName(pFailedSock->u.sll.ifname, NULL, NULL, netTechOui, NULL, NULL, NULL, 0);
  }

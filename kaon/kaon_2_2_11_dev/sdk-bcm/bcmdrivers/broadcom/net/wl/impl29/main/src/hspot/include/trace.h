...
#ifdef DSLCPE
/* change to disable Hspot message on to console when hspot client presents */
#define WL_PRINT(args)		WL_PRINT_ args
#define WL_PRINT_(args...)	TRACE(TRACE_PRINTF, args)
#else

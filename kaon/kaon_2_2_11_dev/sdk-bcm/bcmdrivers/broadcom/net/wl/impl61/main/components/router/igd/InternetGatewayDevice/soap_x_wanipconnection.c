 ...
 *
 * $Id: soap_x_wanipconnection.c 738255 2017-12-27 22:36:47Z $
 */
#include <upnp.h>
...
)
{
	...
	/* << USER CODE START >> */
	upnp_tlv_set(tlv, (uintptr_t)"IP_Routed");
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	upnp_tlv_set(tlv, (uintptr_t)connect);
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	/* << USER CODE START >> */
	upnp_tlv_set(tlv, (uintptr_t)"ERROR_NONE");
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	upnp_tlv_set(tlv, (uintptr_t)inet_ntoa(igd_ctrl->wan_ip));
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	upnp_tlv_set(out_NewConnectionType, (uintptr_t)"IP_Routed");
	upnp_tlv_set(out_NewPossibleConnectionTypes, (uintptr_t)"IP_Routed");
	return OK;
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
	...
	upnp_tlv_set(out_NewRemoteHost, (uintptr_t)map->remote_host);
	upnp_tlv_set(out_NewExternalPort, map->external_port);
	upnp_tlv_set(out_NewProtocol, (uintptr_t)map->protocol);
	upnp_tlv_set(out_NewInternalPort, map->internal_port);
	upnp_tlv_set(out_NewInternalClient, (uintptr_t)map->internal_client);
	upnp_tlv_set(out_NewEnabled, map->enable);
	upnp_tlv_set(out_NewPortMappingDescription, (uintptr_t)map->description);

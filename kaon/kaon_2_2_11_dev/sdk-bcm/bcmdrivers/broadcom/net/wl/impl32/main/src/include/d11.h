 ...
 *
 * $Id: d11.h 769073 2018-11-02 21:41:46Z $
 */
...
#define M_BCN_POWER_ADJUST  (0x70b * 2)
...
#define M_PRS_POWER_ADJUST  (0x70c * 2)
...
#define M_CCASTATS_PTR	(M_PSM_SOFT_REGS_EXT + (0x16 * 2))	/* corerev >= 40 */

/* CCA Statistics */
#define M_CCA_STATS_BLK_PRE40 (0x360 * 2)
#define M_CCA_STATS_BLK (0xc6c * 2)	/* corerev >= 40 */
/* offsets */
#define M_CCA_TXDUR_L	    (0x0  * 2)
#define M_CCA_TXDUR_H	    (0x1  * 2)
#define M_CCA_INBSS_L	    (0x2  * 2)
#define M_CCA_INBSS_H	    (0x3  * 2)
#define M_CCA_OBSS_L	    (0x4  * 2)
#define M_CCA_OBSS_H	    (0x5  * 2)
#define M_CCA_NOCTG_L	    (0x6  * 2)
#define M_CCA_NOCTG_H	    (0x7  * 2)
#define M_CCA_NOPKT_L	    (0x8  * 2)
#define M_CCA_NOPKT_H	    (0x9  * 2)
#define M_MAC_DOZE_L	    (0xa  * 2)
#define M_MAC_DOZE_H	    (0xb  * 2)
#define M_CCA_TXOP_L	    (0xc  * 2)
#define M_CCA_TXOP_H	    (0xd  * 2)
#define M_CCA_GDTXDUR_L	    (0xe  * 2)
#define M_CCA_GDTXDUR_H	    (0xf  * 2)
#define M_CCA_BDTXDUR_L	    (0x10 * 2)
#define M_CCA_BDTXDUR_H	    (0x11 * 2)
...
#define M_UCODE_FEATURES    (M_PSM_SOFT_REGS + 0x5 * 2) /* ucode feature flags */
...
#define D11AC_M_WOWL_TSCPN_BLK  (0x484 * 2)	/* 0-5 per AC for corerev >= 42 */

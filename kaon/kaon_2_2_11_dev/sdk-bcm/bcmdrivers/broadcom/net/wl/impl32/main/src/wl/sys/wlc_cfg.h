 ...
 *
 * $Id: wlc_cfg.h 733485 2017-11-28 14:10:49Z $
 */
...
#if defined(STB_BCM4360) || defined(STB_BCM43217) || defined(STB_BCM43288)
...
#endif /* defined(STB_BCM4360) || defined(STB_BCM43217) || defined(STB_BCM43288)  */
...
#  if (defined(ACCONF) || defined(LCN40CONF) || defined(LCNCONF) || defined(SSLPNCONF) \
	...
	defined(GCONF) || defined(LCN20CONF))
...
#define ACPHY_DEFAULT		0x006cbff       /* Supported acphy revs:
						 *	0	4360a0
						 *	1	4360b1
						 *	2	4335a0
						 *	3	4350a0/b0/b1
...
#error "WLAMPDU_HOSTREORDER requires PROP_TXSTATUS_ENABLED"
#endif // endif
...
#define MAXSCBCUBBIES		27	/* max number of cubbies in scb container */
#endif // endif
...
#define NTXD_LARGE_AC3X3	1024
#endif // endif

#ifndef NRXD_LARGE_AC3X3
#define NRXD_LARGE_AC3X3	1024
#endif // endif

#ifndef NRXBUFPOST_AC3X3
#define NRXBUFPOST_AC3X3	256	/* # rx buffers posted */
#endif // endif
...
#define MAX_NOTIF_SERVERS	(16+IDSUP_NOTIF_SRVR_OBJS)
#endif // endif

/* Maximum number of notification clients. */
#ifndef MAX_NOTIF_CLIENTS
#define MAX_NOTIF_CLIENTS	(24+IDSUP_NOTIF_CLNT_OBJS)
#endif // endif

 ...
 *
 * $Id: acsd_svr.h 767644 2018-09-20 04:50:39Z $
 */
...
#ifdef DSLCPE_ENDIAN
extern void endian_convert_bss_info(wl_bss_info_t *bi, acs_chaninfo_t *c_info);
extern int dcs_handle_request(char* ifname, wl_bcmdcs_data_t *dcs_data, uint8 mode,
	uint8 count, uint8 csa_mode, acs_chaninfo_t *c_info);
#else
extern int dcs_handle_request(char* ifname, wl_bcmdcs_data_t *dcs_data, uint8 mode,
...
extern int acs_set_pref_chanspec(acs_chaninfo_t *c_info, chanspec_t prefchspec);

 ...
 *
 * $Id: acsd_utils.c 702527 2017-06-01 18:40:46Z $
 */
...
#ifdef DSLCPE_ENDIAN
void endian_convert_bss_info(wl_bss_info_t *bi, acs_chaninfo_t *c_info) {
		...
		bi->vht_rxmcsmap=dtoh16(bi->vht_rxmcsmap);
		bi->vht_txmcsmap=dtoh16(bi->vht_txmcsmap);
...
static void
#ifdef DSLCPE_ENDIAN
dump_bss_info(wl_bss_info_t *bi, acs_chaninfo_t *c_info)
#else
...
void
#ifdef DSLCPE_ENDIAN
dump_networks(char *network_buf, void *c_info_ptr)
{
	acs_chaninfo_t *c_info = (acs_chaninfo_t *)c_info_ptr;
#else

 ...
 *
 * $Id: wlc_channel.h 772103 2019-02-14 08:52:30Z $
 */
...
void wlc_channel_send_chan_event(wlc_info_t *wlc, wl_chan_change_reason_t reason,
	chanspec_t chanspec);
#endif /* WL_AP_CHAN_CHANGE_EVENT */
void wlc_update_rcinfo(wlc_cm_info_t *wlc_cm, bool switch_to_global_opclass);
#ifdef WL_GLOBAL_RCLASS
bool wlc_sta_supports_global_rclass(wlc_info_t *wlc, uint8 *setBitBuff, uint8 *flag);
uint8 wlc_channel_get_cur_rclass(wlc_info_t *wlc);
void wlc_channel_set_cur_rclass(wlc_info_t *wlc, uint8 cur_rclass);

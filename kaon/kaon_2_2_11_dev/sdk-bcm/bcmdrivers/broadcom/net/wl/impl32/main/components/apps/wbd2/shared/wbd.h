 ...
 *
 * $Id: wbd.h 782533 2019-12-23 06:42:04Z $
 */
...
#define WBD_INFO_FLAGS_CONV_RCPI_RSSI	0x0010	/* beacon report rcpi needs converion to rssi ? */
...
/* Check whether rcpi to rssi converion is enabled or not */
#define WBD_RCPITORSSI_ENAB(flags)	((flags) & (WBD_INFO_FLAGS_CONV_RCPI_RSSI))
...
#define WBD_TM_SLV_ACT_FRAME_INTERVAL	1000	/* Send actframe to home channel weak STA (in ms) */
#define WBD_TM_SLV_OFFCHAN_AF_INTERVAL	20	/* Send actframe to off-channel weak STA (in ms) */
#define WBD_TM_SLV_BCN_REQ_INTERVAL	16000	/* Send beacon request to weak STA (in ms) */
#define WBD_TM_MTR_RM_CLIENT_INTERVAL	0	/* Timeout to Remove stale client entry */
...
#define WBD_DEF_CONV_RCPI_TO_RSSI	0	/* Default for rcpi to rssi converion */
...
#ifdef DSLCPE
#define WBD_NVRAM_SLAVE_MSGLVL		"wbd_slave_msglevel"
#endif
...
#define NVRAM_MAP_MULTIHOP		"map_multi_hop"
...
#define WBD_NVRAM_STAMON_CONFIG		"bcm_stamon_config"
...
#define WBD_NVRAM_CONV_RCPI_TO_RSSI		"wbd_conv_rcpi_to_rssi"
...
typedef struct wbd_timeouts {
	...
	int tm_actframe;		/* Timeout to send action frame to associated weak sta */
	int tm_offchan_actframe;	/* Timeout to send off-channel action frame */

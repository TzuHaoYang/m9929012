 ...
 *
 * $Id: bcmstbgpio.h 281567 2011-09-02 18:05:39Z $
 */
#ifndef __bcmstbgpio_h__
#define __bcmstbgpio_h__
...
int bcmgpio_in(int gpio_pin, unsigned long *value);
int bcmgpio_out(int gpio_pin, unsigned long value);

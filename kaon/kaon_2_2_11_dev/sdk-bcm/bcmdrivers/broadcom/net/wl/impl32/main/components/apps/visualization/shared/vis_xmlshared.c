...
#ifdef DSLCPE
		snprintf(tmpstr, sizeof(tmpstr), "%u", networks_list->aps[i].channel);
#else
...
#ifdef DSLCPE
		snprintf(tmpstr, sizeof(tmpstr), "%u", networks_list->aps[i].ctrlch);
#else
...
#ifdef DSLCPE
		snprintf(tmpstr, sizeof(tmpstr), "%u", networks_list->aps[i].maxrate);
#else

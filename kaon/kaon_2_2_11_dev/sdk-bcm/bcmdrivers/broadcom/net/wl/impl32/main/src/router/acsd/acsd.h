 ...
 *
 * $Id: acsd.h 736096 2017-12-13 14:09:16Z $
 */
...
#define acsd_swap64(i) (c_info->endian_swap?bcmswap64(i):(uint64)(i))
#define acsd_swap32(i) (c_info->endian_swap?bcmswap32(i):(uint32)(i))
#define acsd_swap16(i) (c_info->endian_swap?bcmswap16(i):(uint16)(i))

#ifdef htod32
/*acsd use specicial htod32 etc*/
#undef htod32
#undef htod16
#undef dtoh64
#undef dtoh32
...
#undef dtohenum
#endif
#define htod32(i) (acsd_swap32(i))
#define htod16(i) (acsd_swap16(i))
#define dtoh64(i) (acsd_swap64(i))
#define dtoh32(i) (acsd_swap32(i))
#define dtoh16(i) (acsd_swap16(i))
#define htodchanspec(i) (htod16(i))
#define dtohchanspec(i) (dtoh16(i))
#define htodenum(i) (c_info->endian_swap?((sizeof(i) == 4) ? \
			htod32(i) : ((sizeof(i) == 2) ? htod16(i) : i)):i)
#define dtohenum(i) (c_info->endian_swap?((sizeof(i) == 4) ? \
...
#ifdef DSLCPE_ENDIAN
extern void dump_networks(char *network_buf, void *c_info);
#else

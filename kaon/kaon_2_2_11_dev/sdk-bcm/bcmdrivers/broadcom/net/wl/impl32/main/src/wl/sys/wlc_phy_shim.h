 ...
 *
 * $Id: wlc_phy_shim.h 452780 2014-02-01 00:54:24Z $
 */
...
extern void wlapi_bmac_pkteng(wlc_phy_shim_info_t *physhim, bool start,
	uint numpkts);
...
#ifdef BCMLTECOEX
extern int wlapi_ltecx_get_lte_map(wlc_phy_shim_info_t *physhim);

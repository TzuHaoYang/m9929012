  ...
  if (media_specific_info && (media_specific_info[MAC_ADDR_LEN] & I5_MEDIA_INFO_ROLE_STA)) {
    ...
    if (pdevice->parentDevice) {
      ...
      if (!i5DmIsMacNull((unsigned char*)media_specific_info)) {
         ...
         */
        i5_dm_1905_neighbor_type *neighbor = i5Dm1905NeighborFind(pdevice, interface_id,
          pdevice->parentDevice->DeviceId);
        if (neighbor && !i5DmIsMacNull(neighbor->NeighborInterfaceId)) {

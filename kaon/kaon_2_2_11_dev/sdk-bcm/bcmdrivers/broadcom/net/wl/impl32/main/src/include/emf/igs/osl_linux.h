...
#ifdef DSLCPE
extern bool igs_osl_timer_pending(osl_timer_t *t);
extern void igs_osl_task_reschedule(void);
extern void igs_osl_wakeup_clear(void);
extern void igs_osl_timer_expire(osl_timer_t *t);
#endif

 ...
 *
 * $Id: emfc_export.h 722797 2017-09-21 11:32:29Z $
 */
...
typedef struct emfc_wrapper
{
	...
	int32   (*forward_fn)(void *wrapper, void *p, uint32 mgrp_ip,
	                    void *txif, int rt_port);  /*change rt_port to int to have bit 7 available */
#else
	int32   (*forward_fn)(void *wrapper, void *p, uint32 mgrp_ip,
...
extern uint32 emfc_ipv6_input(struct emfc_info *emfc, void *sdu, void *ifp,
                         uint8 *iph, bool rt_port);
extern int32 emfc_mfdb_membership_status_change(struct emfc_info *emfc, uint32 mgrp_ip, void *ifp,int is_valid);

extern int32 emfc_mfdb_ipv6_membership_del(struct emfc_info *emfc, void *mgrp_ip, void *ifp);
extern int32 emfc_mfdb_ipv6_membership_status_change(struct emfc_info *emfc, void *mgrp_ip, void *ifp,int is_valid);
extern int32 emfc_mfdb_ipv6_membership_add(struct emfc_info *emfc, void *mgrp_ip, void *ifp);
extern int32 emfc_mfdb_ipv6_membership_dev_add(void *dev,void *grp, void *ifp);

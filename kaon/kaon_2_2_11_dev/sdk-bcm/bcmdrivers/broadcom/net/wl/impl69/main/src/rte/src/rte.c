 ...
 *
 * $Id: rte.c 792696 2020-11-02 14:04:50Z $
 */
...
void
BCMATTACHFN(hnd_debug_info_net_dev_set)(uint32 net_dev)
{
	hnd_debug_info.net_dev = net_dev;
}

void
BCMATTACHFN(hnd_debug_info_bus_dev_set)(uint32 bus_dev)
{
	hnd_debug_info.bus_dev = bus_dev;
}

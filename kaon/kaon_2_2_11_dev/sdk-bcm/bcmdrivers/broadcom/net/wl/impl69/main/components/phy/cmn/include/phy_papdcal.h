 ...
 *
 * $Id: phy_papdcal.h 791916 2020-10-13 15:17:47Z $
 */
...
int phy_papdcal_set_idx(phy_info_t *pi, int32 idx);
...
int phy_papdcal_get_end_epstblidx(phy_info_t *pi, int32* end_epstblidx);
int phy_papdcal_set_end_epstblidx(phy_info_t *pi, int32 end_epstblidx);
int phy_papdcal_get_epstblsel(phy_info_t *pi, int32* epstblsel);
int phy_papdcal_set_epstblsel(phy_info_t *pi, int32 epstblsel);
int phy_papdcal_get_dump(phy_info_t *pi, int32* papdcal_dump);
int phy_papdcal_set_dump(phy_info_t *pi, int8 papdcal_dump);
int phy_papdcal_get_abort(phy_info_t *pi, int32* papd_abort);
int phy_papdcal_set_abort(phy_info_t *pi, int32 papd_abort);
#endif // endif

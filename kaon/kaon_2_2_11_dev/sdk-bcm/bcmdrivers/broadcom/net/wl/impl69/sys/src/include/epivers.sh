...
#
# $Id: epivers.sh 774931 2019-05-13 04:04:29Z $
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: svn://bcawlan-svnfast.sj.broadcom.net/svn/bcawlan/proj/tags/KUDU/KUDU_REL_17_10_157_2802/src/include/epivers.sh $'

...
/* Offsets into SVMP for 47622/63178 chip */
#define SVMP_47622_FFT_DATA_ADDR 0x1D020

#define SVMP_47622_STATUS_ADDR        0x1D018

#define SVMP_47622_SMPL_CTRL_ADDR     (1 + SVMP_47622_STATUS_ADDR)
#define SVMP_47622_SMPL_ENABLE_ADDR   (2 + SVMP_47622_STATUS_ADDR)
#define SVMP_47622_SMPL_INTERVAL_ADDR (3 + SVMP_47622_STATUS_ADDR)

#define SVMP_47622_HEADER_ADDR        0x1D000
#define SVMP_47622_SMPL_SIZE_ADDR     (SVMP_47622_HEADER_ADDR)
#define SVMP_47622_SMPL_MODE_ADDR     (1 + SVMP_47622_HEADER_ADDR)
#define SVMP_47622_SMPL_CORE_ADDR     (2 + SVMP_47622_HEADER_ADDR)
#define SVMP_47622_SMPL_GAIN_ADDR     (3 + SVMP_47622_HEADER_ADDR)

#define SVMP_47622_HEADER_EXT_ADDR    0x1D010
#define SVMP_47622_SMPL_TIMESTAMP_ADDR_L   (2 + SVMP_47622_HEADER_EXT_ADDR) // set by driver
#define SVMP_47622_SMPL_TIMESTAMP_ADDR_H   (3 + SVMP_47622_HEADER_EXT_ADDR) // set by driver
#define SVMP_47622_SMPL_SEQ_NUM_ADDR       (4 + SVMP_47622_HEADER_EXT_ADDR) // set by driver
// chanspec of +1 chain, set by driver
#define SVMP_47622_SMPL_CHANSPEC_ADDR      (5 + SVMP_47622_HEADER_EXT_ADDR)
// chanspec of 3x3 chain, set by driver
#define SVMP_47622_SMPL_CHANSPEC_3X3_ADDR  (6 + SVMP_47622_HEADER_EXT_ADDR)
#define SVMP_47622_SMPL_COEX_GPIO_MASK_ADDR  (7 + SVMP_AX_HEADER_EXT_ADDR)
/* End of offsets into SVMP for AX chip */
...
struct _airiq_scan_config {
	...
	uint32 real_fft_count[MAXCHANNEL];
	uint32 real_capture_time[MAXCHANNEL];
#endif // endif
};

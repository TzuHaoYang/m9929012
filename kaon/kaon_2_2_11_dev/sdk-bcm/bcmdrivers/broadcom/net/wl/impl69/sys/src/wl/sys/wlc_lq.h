 ...
 *
 * $Id: wlc_lq.h 792523 2020-10-29 09:46:36Z $
 */
...
extern uint8 wlc_lq_get_current_chan_utilization(wlc_info_t *wlc);
#else
...
#define wlc_lq_get_current_chan_utilization(a) BCME_OK
#endif /* WLCHANIM */

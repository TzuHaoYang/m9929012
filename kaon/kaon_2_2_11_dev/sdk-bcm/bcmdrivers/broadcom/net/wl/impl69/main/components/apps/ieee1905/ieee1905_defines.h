 ...
 *
 * $Id: ieee1905_defines.h 792602 2020-10-30 08:35:21Z $
 */
...
#ifdef MULTIAP
#define I5_DM_LINK_METRICS_GET_INTERVAL_SEC  0  /* Get link metrics from the interface */
#else
#define I5_DM_LINK_METRICS_GET_INTERVAL_SEC  60 /* Get link metrics from the interface */
#endif // endif

#ifdef MULTIAP
#define I5_MAX_INTF_RCS				16
#define I5_CHSCAN_CAP_SIZE			512
#define I5_RADIO_CAP_SIZE			512
#define I5_MAX_REGCLASS				256
#define IEEE1905_80211_CHAN_PER_REGCLASS	59 /* consider 6G */
#define IEEE1905_MAX_RCCHANNELS			59
...
#define I5_MAX_STR_ETHERTYPE_LEN 6 /* Max length of Ether Type string */

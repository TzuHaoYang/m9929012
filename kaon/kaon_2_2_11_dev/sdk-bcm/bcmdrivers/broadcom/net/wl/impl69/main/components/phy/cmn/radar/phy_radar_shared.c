 ...
 *
 * $Id: phy_radar_shared.c 792578 2020-10-30 02:58:52Z $
 */
	...
	int min_det_pw, uint16 blank_time, uint16 set)
{
	...
	chk_set2 = ((set & EXT_PW_TOL_SET2) && (((max_det_pw > 50) && (max_det_pw <= 430)) &&
		(((max_det_pw - min_det_pw)  >= (blank_time - ((lesi_rev47 || lesi_rev128) ?
		max_pw_tol : max_pw_tol/2))) && ((max_det_pw - min_det_pw) <= (blank_time +
		((lesi_rev47 || lesi_rev128) ? max_pw_tol : max_pw_tol/2)))))) ? TRUE : FALSE;

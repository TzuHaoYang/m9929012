 ...
 *
 * $Id: wbd.h 793876 2020-12-14 07:46:14Z $
 */
...
#define WBD_TM_MTR_ONBOOT_CHSCAN_REQ	60	/* Timeout for Master to send ObBoot CH SCAN Req */
#define WBD_TM_PROCESS_AP_CONFIGURE	20	/* Timeout for further process after all AP's are
						 * configurede
						 */
#define WBD_TM_DO_ONBOOT_SCAN		20	/* Timeout for slave to do onboot scan */
#define WBD_TM_SLV_REQ_CHSCAN_RPT	30	/* Timeout for Slave to send Reqsted CH SCAN Rpt */
...
#define WBD_BH_OPT_MAX_TRY_ON_WEAK	2	/* Default number of backhaul optimization retries
						 ...
						 * formation of loop
						 */
#define WBD_DEF_PRIM_VLAN_ID		110	/* Default Primary VLAN ID */
#define WBD_DEF_SEC_VLAN_ID		120	/* Default Secondary VLAN ID */
...
#define WBD_WL_CHSPEC_DEF_5G_H_EU	"100/80"  /* Default 5GH chanspec on channel 100/80
						   ...
						   */
#define WBD_DEF_PREFERRED_BH_BAND	BAND_5GH	/* Preferred backhaul STA band */
...
/* NVRAMs for Best Backhaul STA Configuration(for band steer in the agent) */
#define WBD_NVRAM_BEST_BSTA_WGHT_IDX		"wbd_best_bsta_wght_idx"
#define WBD_NVRAM_BEST_BSTA_WGHT		"wbd_best_bsta_wght"
#define WBD_NVRAM_BEST_BSTA_BOUNDARIES		"wbd_best_bsta_boundaries"
#define WBD_NVRAM_PREFERRED_BH			"wbd_preferred_bh_band"

/* Minumum Best BSTA boundaries */
#define WBD_BEST_BSTA_MIN_PHYRATE_BOUNDARY	36
#define WBD_BEST_BSTA_MIN_RSSI_BOUNDARY		(-85)

/* Maximum phyrate/RSSI boundary above which the normalized value is 100 */
#define WBD_BEST_BSTA_MAX_PHYRATE_BOUNDARY	100
#define WBD_BEST_BSTA_MAX_RSSI_BOUNDARY		(-45)

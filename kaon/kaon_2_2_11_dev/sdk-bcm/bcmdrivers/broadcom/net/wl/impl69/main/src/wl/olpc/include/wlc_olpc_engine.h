...
/* restart autocal timer */
extern void wlc_olpc_autocal_timer_reload(wlc_olpc_eng_info_t *olpc);

/* return true if auto calibration is enabled */
extern bool wlc_olpc_eng_autocal_enab(wlc_olpc_eng_info_t *olpc);

 ...
 *
 * $Id: wlc_frag.h 748363 2018-02-22 15:06:40Z $
 */
...
bool wlc_defrag_in_progress(wlc_frag_info_t *frag, struct scb *scb, uint8 prio);
uint8 * wlc_defrag_first_frag_body_get(wlc_info_t *wlc, struct scb *scb, uint8 prio);

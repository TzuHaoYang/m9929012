 ...
 *
 * $Id: wlc_txbf.h 792274 2020-10-22 00:35:38Z $
 */
...
#define TXBF_SU_BFE_SMTH_OVRD_DIS		0x80
...
extern uint8 wlc_txbf_get_bfe_cap(wlc_txbf_info_t *txbf, wlc_bsscfg_t *cfg);
...
#endif // endif
extern bool wlc_disable_bfe_for_smth(wlc_txbf_info_t *txbf, wlc_bsscfg_t *cfg);
extern bool wlc_txbf_autotxvcfg_get(wlc_txbf_info_t *txbf, bool add);
extern void wlc_txbf_bfecap_init(wlc_txbf_info_t *txbf, wlc_bsscfg_t *cfg);
extern uint8 wlc_txbf_bfe_maxsts(wlc_txbf_info_t *txbf);
#endif /* _wlc_txbf_h_ */

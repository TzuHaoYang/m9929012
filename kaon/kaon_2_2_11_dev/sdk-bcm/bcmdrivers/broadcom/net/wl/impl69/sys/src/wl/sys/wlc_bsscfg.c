 ...
 *
 * $Id: wlc_bsscfg.c 793346 2020-11-24 06:48:09Z $
 */
 ...
 * which is configured as AP.
 */
static void wlc_bsscfg_set_main_ap(wlc_info_t *wlc)
{
	wlc_bsscfg_t *cfg;
	int i = 0;

	wlc->main_ap_bsscfg = NULL;

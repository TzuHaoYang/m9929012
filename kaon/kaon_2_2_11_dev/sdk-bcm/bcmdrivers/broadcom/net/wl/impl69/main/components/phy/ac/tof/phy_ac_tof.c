...
/* 43684 k values */
#define TOF_INITIATOR_K_43684_80M      33893 /* initiator K value for 80M */
#define TOF_TARGET_K_43684_80M         33893 /* target K value for 80M */

#define TOF_INITIATOR_K_43684_40M      34974 /* initiator K value for 40M */
#define TOF_TARGET_K_43684_40M         34974 /* target K value for 40M */

#define TOF_INITIATOR_K_43684_20M      35938 /* initiator K value for 20M */
#define TOF_TARGET_K_43684_20M         35938 /* target K value for 20M */

#define TOF_INITIATOR_K_43684_2G       36061 /* initiator K value for 2G */
#define TOF_TARGET_K_43684_2G          36061 /* target K value for 2G */

static const  uint32 BCMATTACHDATA(proxd_43684_80m_k_values)[] =
/* 42, 58, 106, 122, 138, 155 */
{0x00110011, 0x00130013, 0x000a000a, 0x00030003, 0x00060006, 0x00000000};

static const  uint32 BCMATTACHDATA(proxd_43684_40m_k_values)[] =
/* 38, 46, 54, 62, 102 110 */
{0x02d202d2, 0x00440044, 0x08c608c6, 0x00360036, 0x02e402e4, 0x00290029,
/* 118, 126, 134, 142, 151, 159 */
0x000c000c, 0x05620562, 0x00310031, 0x00000000, 0x164d164d, 0x00200020};

static const  uint32 BCMATTACHDATA(proxd_43684_20m_k_values)[] =
/* 36 - 64 */
{0x00540054, 0x00550055, 0x00520052, 0x005c005c, 0x00450045, 0x004e004e, 0x00410041, 0x00400040,
/* 100 - 144 */
0x00330033, 0x00340034, 0x002d002d, 0x002b002b, 0x00280028, 0x002a002a,
0x00270027, 0x00160016, 0x00240024, 0x00200020, 0x001c001c, 0x00160016,
/* 149 - 165 */
0x00160016, 0x00250025, 0x001a001a, 0x00120012, 0x00000000};

static const  uint32 BCMATTACHDATA(proxd_43684_2g_k_values)[] =
/* 1 - 7 */
{0x001b001b, 0x000f000f, 0x000d000d, 0x000a000a, 0x00120012, 0x00140014, 0x000c000c,
/* 8 - 14 */
0x000a000a, 0x000a000a, 0x00050005, 0x00070007, 0x00090009, 0x00000000, 0};

/* 47622 k values */
#define TOF_INITIATOR_K_47622_80M      34329 /* initiator K value for 80M */
#define TOF_TARGET_K_47622_80M         34329 /* target K value for 80M */

#define TOF_INITIATOR_K_47622_40M      35331 /* initiator K value for 40M */
#define TOF_TARGET_K_47622_40M         35331 /* target K value for 40M */

#define TOF_INITIATOR_K_47622_20M      36284 /* initiator K value for 20M */
#define TOF_TARGET_K_47622_20M         36284 /* target K value for 20M */

#define TOF_INITIATOR_K_47622_2G       36418 /* initiator K value for 2G */
#define TOF_TARGET_K_47622_2G          36418 /* target K value for 2G */

static const  uint32 BCMATTACHDATA(proxd_47622_80m_k_values)[] =
/* 42, 58, 106, 122, 138, 155 */
{0x000f000f, 0x000d000d, 0x000b000b, 0x00030003, 0x00000000, 0x00000000};

static const  uint32 BCMATTACHDATA(proxd_47622_40m_k_values)[] =
/* 38, 46, 54, 62, 102 110 */
{0x001e001e, 0x002a002a, 0x00000000, 0x00060006, 0x000e000e, 0x00120012,
/* 118, 126, 134, 142, 151, 159 */
0x00110011, 0x000a000a, 0x00070007, 0x00180018, 0x000f000f, 0x00020002};

static const  uint32 BCMATTACHDATA(proxd_47622_20m_k_values)[] =
/* 36 - 64 */
{0x00390039, 0x003d003d, 0x002d002d, 0x00340034, 0x002f002f, 0x00320032, 0x002c002c, 0x002c002c,
/* 100 - 144 */
0x00240024, 0x001a001a, 0x001d001d, 0x00180018, 0x001b001b, 0x00130013, 0x00140014, 0x000e000e,
0x000c000c, 0x00100010, 0x00000000, 0x000c000c,
/* 149 - 165 */
0x00030003, 0x00190019, 0x000c000c, 0x000c000c, 0x00070007};

static const  uint32 BCMATTACHDATA(proxd_47622_2g_k_values)[] =
{0x00180018, 0x00130013, 0x00140014, 0x000f000f, 0x00100010, 0x00100010, 0x000a000a, /* 1 -7 */
0x000f000f, 0x000e000e, 0x000a000a, 0x00010001, 0x00040004, 0x00030003, 0x00000000 /* 8 - 14 */
};
...
static const  int32 BCMATTACHDATA(proxdt_rate_offset_160m)[] = { 0, 13400, -2804, -2804 };

static const  int32 BCMATTACHDATA(proxdi_rate_offset_2g_43684)[] = { 1328, 7855, 61, 61 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_20m_43684)[] = { 1315, 7858, 45, 36 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_40m_43684)[] = { 1933, 7984, 162, 158 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_80m_43684)[] = { 1630, 7432, 0, 0 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_160m_43684)[] = { 0, 1587, 1746, -2804 };

static const  int32 BCMATTACHDATA(proxdt_rate_offset_2g_43684)[] = { 1328, 7855, 61, 61 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_20m_43684)[] = { 1315, 7858, 45, 36 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_40m_43684)[] = { 1933, 7984, 162, 158 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_80m_43684)[] = { 1630, 7432, 0, 0 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_160m_43684)[] = { 0, 1587, 1746, -2804 };

static const  int32 BCMATTACHDATA(proxdi_rate_offset_2g_47622)[] = { 1419, 7854, 41, 41 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_20m_47622)[] = { 1449, 7875, 40, 46 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_40m_47622)[] = { 2045, 7996, 157, 165 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_80m_47622)[] = { 1785, 7541, 0, 0 };
static const  int32 BCMATTACHDATA(proxdi_rate_offset_160m_47622)[] = { 1385, 7126, 0, 0 };

static const  int32 BCMATTACHDATA(proxdt_rate_offset_2g_47622)[] = { 1419, 7854, 41, 41 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_20m_47622)[] = { 1449, 7875, 40, 46 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_40m_47622)[] = { 2045, 7996, 157, 165 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_80m_47622)[] = { 1785, 7541, 0, 0 };
static const  int32 BCMATTACHDATA(proxdt_rate_offset_160m_47622)[] = { 1385, 7126, 0, 0 };
...
static const int32 BCMATTACHDATA(proxd_subbw_offset_160m_47622)[3][5] = {
	/* 160M-80M */
	{ 342, 66479, 60738, 0, 0 },
	/* 160M -40M */
	{ 415, 66406, 60665, 0, 0 },
...
static int phy_ac_tof_chan_freq_response(phy_type_tof_ctx_t *ctx, int len, int nbits,
		...
		uint8 sts_offset, const bool single_core, bool tdcs_en);
...
phy_ac_tof_chan_freq_response(phy_type_tof_ctx_t *ctx, int fft_len, int nbits, bool swap_pn_half,
		...
		const bool single_core, bool tdcs_en)
{
	phy_ac_tof_info_t *tofi = (phy_ac_tof_info_t *)ctx;
	phy_info_t *pi = tofi->pi;
	...
	uint32 table_idx, table_width, t_core, t_offset, sts_offset;
	int err = BCME_OK;
	...
	if ((len != TOF_NFFT_20MHZ) && (len != TOF_NFFT_40MHZ) &&
	    (len != TOF_NFFT_80MHZ) && (len != TOF_NFFT_160MHZ)) {
		return BCME_ERROR;
	}
	...
	sts_offset = CHANESTTBL_REV0_DATA_OFFSET;
	t_offset = single_core ? 0 : sts_offset * sts;
		...
		if (bwidx) {
			if (ACMAJORREV_GE40(pi->pubpi->phy_rev)) {
				if (CHSPEC_IS160(chanspec)) {
					...
					/* for 160MHz */
					kt -= tofi->proxd_subbw_offset_160m[bwidx - 1][ackidx + 1];
					ki -= tofi->proxd_subbw_offset_160m[bwidx - 1][rateidx + 1];
				} else {
...
BCMATTACHFN(phy_ac_nvram_proxd_read)(phy_info_t *pi, phy_ac_tof_info_t *tofi)
{
	...
	for (i = 0; i < 4 / sizeof(int32); i++) {
		if (ACMAJORREV_47(pi->pubpi->phy_rev)) {
			tofi->proxdi_rate_offset_160m[i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxdi_rate160m_43684, i, proxdi_rate_offset_160m_43684[i]);
		} else if (ACMAJORREV_51_131(pi->pubpi->phy_rev)) {
			tofi->proxdi_rate_offset_160m[i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxdi_rate160m_47622, i, proxdi_rate_offset_160m_47622[i]);
		} else {
			tofi->proxdi_rate_offset_160m[i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
	...
	for (i = 0; i < sizeof(proxdt_rate_offset_160m) / sizeof(int32); i++) {
		if (ACMAJORREV_47(pi->pubpi->phy_rev)) {
			tofi->proxdt_rate_offset_160m[i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxdt_rate160m_43684, i, proxdt_rate_offset_160m_43684[i]);
		} else if (ACMAJORREV_51_131(pi->pubpi->phy_rev)) {
			tofi->proxdt_rate_offset_160m[i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxdt_rate160m_47622, i, proxdt_rate_offset_160m_47622[i]);
		} else {
	...
	for (i = 0; i < 5; i++) {
		if (ACMAJORREV_47(pi->pubpi->phy_rev)) {
			...
			tofi->proxd_subbw_offset_160m[0][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxd_sub160m80m, i, proxd_subbw_offset_160m_47622[0][i]);
		} else {
			tofi->proxd_subbw_offset_160m[0][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
	...
	for (i = 0; i < 5; i++) {
		if (ACMAJORREV_47(pi->pubpi->phy_rev)) {
			...
			tofi->proxd_subbw_offset_160m[1][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxd_sub160m40m, i, proxd_subbw_offset_160m_47622[1][i]);
		} else {
			tofi->proxd_subbw_offset_160m[1][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
	...
	for (i = 0; i < 5; i++) {
		if (ACMAJORREV_47(pi->pubpi->phy_rev)) {
			...
			tofi->proxd_subbw_offset_160m[2][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,
				rstr_proxd_sub160m20m, i, proxd_subbw_offset_160m_47622[2][i]);
		} else {
			tofi->proxd_subbw_offset_160m[2][i] = PHY_GETINTVAR_ARRAY_DEFAULT(pi,

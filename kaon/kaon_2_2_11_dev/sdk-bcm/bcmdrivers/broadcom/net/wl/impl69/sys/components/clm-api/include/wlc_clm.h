...
typedef struct clm_channels_params {
	 ...
	 */
	unsigned int device_categories;
...
extern clm_result_t clm_limits(const clm_country_locales_t *locales,
	clm_band_t band, unsigned int channel, clm_bandwidth_t bw, int ant_gain,
	int sar, clm_ext_chan_t extension_channel, clm_power_limits_t *limits,
 ...
 */
extern clm_result_t clm_limits(const clm_country_locales_t *locales,
	clm_band_t band, unsigned int channel, int ant_gain,
...
extern clm_result_t clm_available_he_limits(const clm_country_locales_t *locales,
	clm_band_t band, clm_bandwidth_t bandwidth, unsigned int channel,
...
extern clm_result_t clm_he_limit(const clm_country_locales_t *locales,
	clm_band_t band, clm_bandwidth_t bandwidth, unsigned int channel,
	int ant_gain, clm_limits_type_t limits_type,
...
extern clm_result_t clm_agg_map_iter(const clm_agg_country_t agg,
	clm_agg_map_t *map, ccode_t cc, unsigned int *rev);

 ...
 *
 * $Id: phy_ac_papdcal.c 791921 2020-10-13 17:27:25Z $
 */
#include <phy_cfg.h>
#include <typedefs.h>
#include <bcmdefs.h>
...
static void phy_ac_papd_phy_setup_majorrev44_51_128_129_131(phy_info_t *pi);
...
static void phy_ac_papd_phy_cleanup_majorrev44_51_128_129_131(phy_info_t *pi);
...
static void phy_ac_papd_radio_lpbk_setup_20708(phy_info_t *pi);
...
static void phy_ac_papd_radio_lpbk_cleanup_majorrev51_128_131(phy_info_t *pi);
...
static void
phy_ac_papd_radio_lpbk_setup_20708(phy_info_t *pi)
{
	phy_info_acphy_t *aci = (phy_info_acphy_t *)pi->u.pi_acphy;
	phy_ac_papdcal_info_t *papdcali = (phy_ac_papdcal_info_t *)pi->u.pi_acphy->papdcali;
	phy_ac_papdcal_params_t *params = papdcali->papd_params;
	uint8 core, radio_rev_id, rxdb_spare_auxgm;
	...
	FOREACH_CORE(pi, core) {
		...
		if (CHSPEC_IS2G(pi->radio_chanspec)) {
			...
			/* Set TX and RX coupler attenuation */
			//MOD_RADIO_REG_20708(pi, TX2G_IPA_REG0, core, tx2g_ipa_cal_atten,
			//	params->tx_atten_2g);
			MOD_RADIO_REG_20708(pi, RX5G_REG4, core, rxdb_coup_loopback_attn,
				params->rx_atten_2g);
		} else {
			RADIO_REG_LIST_START
				/* Routing into AuxGM, so LNA settings below are redundand,
			...
			RADIO_REG_LIST_EXECUTE(pi, core);
				...
				if (radio_rev_id == 0) {
					MOD_RADIO_REG_20708(pi, TX2G_MISC_CFG6, core,
						tx2g_spare0, 0);
					MOD_RADIO_REG_20708(pi, RXDB_SPARE, core,
						rxdb_spare, 0);
					MOD_RADIO_REG_20708(pi, RX2G_REG4, core,
						rx2g_lna_tr_rx_en, 0);
					MOD_RADIO_REG_20708(pi, RXDB_CFG1_OVR, core,
						ovr_rx2g_lna_tr_rx_en, 1);
					MOD_RADIO_REG_20708(pi, RX5G_REG1, core,
						rx5g_lna_tr_rx_en, 0);
					MOD_RADIO_REG_20708(pi, RXDB_CFG1_OVR, core,
						ovr_rx5g_lna_tr_rx_en, 1);
				} else {
			...
			/* Set TX and RX coupler attenuation */
			//MOD_RADIO_REG_20708(pi, TX5G_IPA_REG0, core, tx5g_ipa_cal_atten,
			//	params->tx_atten_5g);
			MOD_RADIO_REG_20708(pi, RX5G_REG4, core, rxdb_coup_loopback_attn,
				params->rx_atten_5g);
		...
		if (WBPAPD_ENAB(pi)) {
			RADIO_REG_LIST_START
				...
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG1, core, tia_g11, 0x0)
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG2, core, tia_g12, 0x10a)
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG3, core, tia_g21, 0x1765)
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG4, core, tia_g22, 0x760)
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG6, core, tia_c11, 0x7)
				/* LPF */
				...
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG1, core, lpf_g32, 0xfae)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG2, core, lpf_g33, 0xb16)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG3, core, lpf_g34, 0x18e4)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG4, core, lpf_g43, 0x277)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG7, core, lpf_c42, 0xb)
				/* Bias */
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG5, core, tia_opamp1_bias, 0x28)
				MOD_RADIO_REG_20708_ENTRY(pi, TIA_REG5, core, tia_opamp2_bias, 0x19)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_OVR1, core, ovr_lpf_opamp3_bias,
					1)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_OVR1, core, ovr_lpf_opamp4_bias,
					1)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG11, core, lpf_opamp3_bias,
					0x14)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_REG6, core, lpf_opamp4_bias, 0x14)

				/* Tighten TX notch */
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g1, 1)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g1_cm, 1)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_OVR1, core,
				...
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g3, 1)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_REG2, core,
					lpf_notch_g1, 0x159)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_REG5, core,
					lpf_notch_g1_cm, 0x0)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_REG3, core,
					lpf_notch_g2, 0x159)
				MOD_RADIO_REG_20708_ENTRY(pi, LPF_NOTCH_REG4, core,
					lpf_notch_g3, 0x55)
			RADIO_REG_LIST_EXECUTE(pi, core);
		}
	}
	...
	FOREACH_CORE(pi, core) {
		...
		if (WBPAPD_ENAB(pi)) {
			RADIO_REG_LIST_START
				/* Widen TX filter */
				/* TIA */
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_CFG1_OVR, core, ovr_tia_g11, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_CFG1_OVR, core, ovr_tia_g12, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_CFG1_OVR, core, ovr_tia_g21, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_CFG1_OVR, core, ovr_tia_g22, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_CFG1_OVR, core, ovr_tia_c11, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG1, core, tia_g11, 0x0)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG2, core, tia_g12, 0x10a)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG3, core, tia_g21, 0x1765)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG4, core, tia_g22, 0x760)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG6, core, tia_c11, 0x7)
				/* LPF */
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_g32, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_g33, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_g34, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_g43, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_c42, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG1, core, lpf_g32, 0xfae)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG2, core, lpf_g33, 0xb16)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG3, core, lpf_g34, 0x18e4)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG4, core, lpf_g43, 0x277)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG7, core, lpf_c42, 0xb)
				/* Bias */
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG5, core, tia_opamp1_bias, 0x28)
				MOD_RADIO_REG_20710_ENTRY(pi, TIA_REG5, core, tia_opamp2_bias, 0x19)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_opamp3_bias,
					1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_OVR1, core, ovr_lpf_opamp4_bias,
					1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG11, core, lpf_opamp3_bias,
					0x14)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_REG6, core, lpf_opamp4_bias, 0x14)

				/* Tighten TX notch */
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g1, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g1_cm, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_OVR1, core,
				...
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_OVR1, core,
					ovr_lpf_notch_g3, 1)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_REG2, core,
					lpf_notch_g1, 0x159)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_REG5, core,
					lpf_notch_g1_cm, 0x0)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_REG3, core,
					lpf_notch_g2, 0x159)
				MOD_RADIO_REG_20710_ENTRY(pi, LPF_NOTCH_REG4, core,
					lpf_notch_g3, 0x55)
			RADIO_REG_LIST_EXECUTE(pi, core);
		}
	}
...
static void
phy_ac_papd_radio_lpbk_cleanup_majorrev51_128_131(phy_info_t *pi)
{
	/* restore radio config back */
	phy_info_acphy_t *aci = (phy_info_acphy_t *)pi->u.pi_acphy;
...
static void
phy_ac_papd_phy_cleanup_majorrev44_51_128_129_131(phy_info_t *pi)
{
	phy_info_acphy_t *pi_ac = (phy_info_acphy_t *)pi->u.pi_acphy;
	acphy_rxcal_phyregs_t *porig = (pi_ac->ac_rxcal_phyregs_orig);
	...
	if ((ACMAJORREV_51_129_131(pi->pubpi->phy_rev) || ACMAJORREV_128(pi->pubpi->phy_rev)) &&
		WBPAPD_ENAB(pi)) {
		/* Restore farrow */
...
static void
phy_ac_papd_phy_setup_majorrev44_51_128_129_131(phy_info_t *pi)
{
	phy_info_acphy_t *pi_ac = (phy_info_acphy_t *)pi->u.pi_acphy;
	acphy_rxcal_phyregs_t *porig = (pi_ac->ac_rxcal_phyregs_orig);
	uint8 core;
...
wlc_phy_txpwr_papd_cal_run_tiny(phy_info_t *pi,	uint8 tx_pre_cal_pwr_ctrl_state, int8 cal_core)
{
	...
	if (ACMAJORREV_51_129_130_131(pi->pubpi->phy_rev) ||
		ACMAJORREV_128(pi->pubpi->phy_rev))
		/* FIXME6715 */
		phy_ac_papd_phy_setup_majorrev44_51_128_129_131(pi);
	...
	if (ACMAJORREV_51(pi->pubpi->phy_rev)) {
		...
		numiter = params->papd_iter;
		phy_ac_papd_radio_lpbk_setup_20708(pi);
	} else if (ACMAJORREV_131(pi->pubpi->phy_rev)) {
		numiter = params->papd_iter;
	...
	if (ACMAJORREV_129(pi->pubpi->phy_rev)) {
		...
		phy_ac_papd_radio_lpbk_cleanup_majorrev51_128_131(pi);
	} else {
	...
	if (ACMAJORREV_51_129_130_131(pi->pubpi->phy_rev) ||
		ACMAJORREV_128(pi->pubpi->phy_rev)) {
		/* FIXME6715 */
		phy_ac_papd_phy_cleanup_majorrev44_51_128_129_131(pi);
	}
...
phy_ac_papd_cal_eps_calc_tiny(phy_info_t *pi, uint8 core, uint16 *bbmult)
{
	...
	if (ACMAJORREV_129(pi->pubpi->phy_rev) || ACMAJORREV_128(pi->pubpi->phy_rev)) {
...
phy_ac_papd_cal_set_tx_gain(phy_info_t *pi, uint8 core, uint16 *bbmult, uint8 *calmode)
{
	...
	if (ACMAJORREV_51_129_130_131(pi->pubpi->phy_rev) ||
		...
		else if (ACMAJORREV_129(pi->pubpi->phy_rev) || ACMAJORREV_128(pi->pubpi->phy_rev))

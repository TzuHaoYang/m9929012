 ...
 *
 * $Id: wlc_bmac.h 793797 2020-12-10 06:31:26Z $
 */
...
/*
 * BCA BTCX configs:
 * 1. BFL_BTCOEX set and !BFL2_BTC3WIREONLY and !BFL2_BTCLEGACY set --> SECI coex
 * 2. BFL_BTCOEX set and  BFL2_BTC3WIREONLY and  BFL2_BTCLEGACY set --> GCI based 3-wire coex
 * 3. BFL_BTCOEX set and !BFL2_BTC3WIREONLY and  BFL2_BTCLEGACY set --> sw/GPIO based 3-wire coex
 */
...
/* ECI -- pure ECI solution (combo chip) not currently supported in BCA */
#define BCMECICOEX_ENAB_BMAC(wlc_hw) \
	...
	D11REV_LT(wlc_hw->corerev, 65) && \
	MCAP_BTCX_SUPPORTED_WLCHW(wlc_hw))

/* pre-GCI, chipcommon SECI */
#define BCMCCSECICOEX_ENAB_BMAC(wlc_hw) \
	((((wlc_hw_info_t*)(wlc_hw))->boardflags & BFL_BTCOEX) && \
	!(((wlc_hw_info_t*)(wlc_hw))->boardflags2 & BFL2_BTCLEGACY) && \
...
#define BCMSECICOEX_ENAB_BMAC(wlc_hw) \
	...
	D11REV_GT(wlc_hw->corerev, 64) && \
	MCAP_BTCX_SUPPORTED_WLCHW(wlc_hw))

/* GCI-based 3-wire coex */
...
#else
#define BTCX_ENAB(wlc_hw)		(0)
#define SWBTCX_ENAB(wlc_hw)		(0)
...
extern bool wlc_bmac_recv(wlc_hw_info_t *wlc_hw, uint fifo, bool bound,
...
#if defined(BCMHME)
extern int wlc_bmac_hme_macifs_upd(wlc_info_t *wlc, dma64addr_t hmeaddr, uint hmelen);
#endif /* BCMHME */
#endif /* BCMHWA */
...
extern bool wlc_bmac_offload_rxsts_new_ready(wlc_hw_info_t *wlc_hw);
...
extern void wlc_bmac_upd_ifs(wlc_hw_info_t *wlc_hw);

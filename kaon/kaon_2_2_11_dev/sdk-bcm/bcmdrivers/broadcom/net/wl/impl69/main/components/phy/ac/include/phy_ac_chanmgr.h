 ...
 *
 * $Id: phy_ac_chanmgr.h 791920 2020-10-13 16:39:06Z $
 */
...
extern uint8 phy_ac_chanmgr_get_chan_freq_range(phy_info_t *pi, chanspec_t chanspec,
	uint8 core_segment_mapping);
extern void  phy_ac_chanmgr_get_chan_freq_range_80p80_srom12(phy_info_t *pi,
		chanspec_t chanspec, uint8 *freq);
extern uint8 phy_ac_chanmgr_get_chan_freq_range_srom12(phy_info_t *pi, chanspec_t chanspec);
extern uint8 phy_ac_chanmgr_chan2freq_range_srom12(phy_info_t *pi, chanspec_t chanspec);
...
extern void wlc_phy_rxcore_setstate_acphy(phy_info_t *pi, uint8 rxcore_bitmask, uint8 phytxchain);
...
void phy_ac_chanmgr_get_operating_chanspecs(phy_info_t *pi, chanspec_t chspec[2]);
...
int phy_ac_chanmgr_iovar_get_loftcompshift_ovrd(phy_ac_chanmgr_info_t *chanmgri, int32 *ret_val);
int phy_ac_chanmgr_iovar_set_loftcompshift_ovrd(phy_ac_chanmgr_info_t *chanmgri, int32 set_val);

void phy_ac_chanmgr_cal_init(phy_info_t *pi);

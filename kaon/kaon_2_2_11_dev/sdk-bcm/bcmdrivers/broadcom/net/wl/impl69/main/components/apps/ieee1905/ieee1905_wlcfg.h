...
#define I5_WLCFG_NVRAM_MAP_CERT       "map_cert"
...
/* Extension of Authentication Types for MultiAP R2*/
#define MAP_WPS_AUTHTYPE_SAE  0x0040
...
int i5WlCfgMakeWlPrefix(const char *ifname, char *prefix, int prefix_len);
...
int i5WlCfgChannelToband(unsigned char opclass, unsigned char channel);

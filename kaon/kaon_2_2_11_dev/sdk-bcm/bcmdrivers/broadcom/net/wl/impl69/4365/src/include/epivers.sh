...
#
# $Id: epivers.sh 708017 2017-06-29 14:11:45Z $
#
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: svn://bcawlan-svnfast.sj.broadcom.net/svn/bcawlan/proj/tags/EAGLE/EAGLE_REL_10_10_131_76/src/include/epivers.sh $'

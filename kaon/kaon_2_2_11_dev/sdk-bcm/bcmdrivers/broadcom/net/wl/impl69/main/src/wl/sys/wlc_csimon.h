...
/** Check if CSIMON is enabled globally and for the client */
extern bool wlc_csimon_enabled(wlc_info_t *wlc, scb_t *scb);
...
/** Worklet/DPC for M2M interrupts */
extern void BCMFASTPATH wlc_csimon_worklet(wlc_info_t *wlc);

/** Disable M2M interrupts */
extern void wlc_csimon_intrsoff(wlc_info_t *wlc);

/** Enable M2M interrupts */
extern void wlc_csimon_intrson(wlc_info_t *wlc);

/** Delete/free the NIC-mode watchdog timer */
extern void wlc_csimon_wd_timer_del(wlc_info_t *wlc);

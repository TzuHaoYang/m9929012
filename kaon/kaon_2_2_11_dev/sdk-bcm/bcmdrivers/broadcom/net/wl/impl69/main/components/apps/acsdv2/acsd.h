 ...
 *
 * $Id: acsd.h 787899 2020-06-16 04:15:05Z $
 */
...
#define ACSD_5G(fmt, arg...) \
		do { if (acsd_debug_level & ACSD_DEBUG_5G) \
			printf(fmt, ##arg); } while (0)
...
#define CH_SCORE_REPBSS		12
#define CH_SCORE_REPTXOP	13
#define CH_SCORE_MAX		14
...
#define ACS_INVALID_NONPSC	0x40	/* Invalid non psc channels */

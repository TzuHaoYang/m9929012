 ...
 *
 * $Id: wlc_cfg.h 793816 2020-12-10 18:05:09Z $
 */
...
/* Derive BANDMASK from individual bands */
#define BANDMASK	((BAND2G << 0) | (BAND5G << 1) | (BAND6G << 2))

/* single band or not? */
#if !!(BANDMASK & (BANDMASK - 1))
#define MULTIBAND
#endif // endif
...
#define ACPHY_DEFAULT5		0x0000000F	/* Supported acphy revs:
						 *	128	6878
						 *	129	6710a0
						 *	130	6715a0
						 *	131	6756a0
...
#if (BAND5G || BAND6G)
#if !defined(WL11H)
#error	"WL11H is required when 5G or 6G band support is configured"
#endif // endif
#endif /* BAND5G || BAND6G */
...
#error "STS_XFER feature depends on BULKRX_PKTLIST"
#endif /* BULKRX_PKTLIST */

#if defined(STS_FIFO_RXEN)
#error "STS_XFER must not be defined along with STS_FIFO_RXEN"
#endif /* STS_FIFO_RXEN */

#if defined(STS_XFER_M2M_INTR) && defined(BCMHWA)
/**
 ...
 */
#error "BCMHWA must not be defined along with STS_XFER_M2M_INTR"
#endif /* STS_XFER_M2M_INTR && BCMHWA */
...
#ifdef BCMQT
#define HWA_DEFAULT	0x0000001e	/* Supported  HWA revs: 129(43684b0), 130(43684c0),
					 * 131(6715a0) 132(6715b0)
					 */
#else
#define HWA_DEFAULT	0x0000000e	/* Supported  HWA revs: 129(43684b0), 130(43684c0),
					 * 131(6715a0)
					 */
#endif /* BCMQT */
...
/* For undefined values, use defaults */
#ifndef HWACONF
#define HWACONF	HWA_DEFAULT
#endif // endif

#define HWACONF_BASE		128
#define HWACONF_WIDTH		32
#define HWACONF_CHK(val, base)	(((val) >= (base)) && ((val) < ((base) + HWACONF_WIDTH)))
#define HWACONF_REV(val, base)	(HWACONF_CHK(val, base) ? ((val) - (base)) : (0))

#define HWACONF_HAS(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_HAS(HWACONF, HWACONF_REV(val, HWACONF_BASE))))
#define HWACONF_IS(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_IS(HWACONF, HWACONF_REV(val, HWACONF_BASE))))
#define HWACONF_GE(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_GE(HWACONF, HWACONF_REV(val, HWACONF_BASE))))
#define HWACONF_GT(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_GT(HWACONF, D11CONF_REV(val, HWACONF_BASE))))
#define HWACONF_LT(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_LT(HWACONF, D11CONF_REV(val, HWACONF_BASE))))
#define HWACONF_LE(val) (\
	(HWACONF_CHK(val, HWACONF_BASE) && CONF_LE(HWACONF, D11CONF_REV(val, HWACONF_BASE))))

#define HWAREV_IS(var, val)	(HWACONF_HAS(val) && (HWACONF_IS(val) || ((var) == (val))))
#define HWAREV_GE(var, val)	(HWACONF_GE(val) && (!HWACONF_LT(val) || ((var) >= (val))))
#define HWAREV_GT(var, val)	(HWACONF_GT(val) && (!HWACONF_LE(val) || ((var) > (val))))
#define HWAREV_LT(var, val)	(HWACONF_LT(val) && (!HWACONF_GE(val) || ((var) < (val))))
#define HWAREV_LE(var, val)	(HWACONF_LE(val) && (!HWACONF_GT(val) || ((var) <= (val))))
#endif /* BCMHWA */
...
#endif // endif
#if D11CONF_HAS(132)
#define VASIP_11AX_4X4_WAV2_ENAB 1
#endif // endif
...
#ifdef WLC_OFFLOADS_M2M_INTR
#define	NRXBUFPOST	192		/* try to keep this # rbufs posted to the chip */
#else
...
#else /* !BCMQT */
#ifdef STB
/* PCI Root-complex on STB platform has configured with MPS value as 128 bytes */
#define RXBURSTLEN_HE		128
#else /* !STB */
...
#ifdef WL_AIR_IQ
#define AIRIQ_NOTIF_CLNT_OBJ  1
#else
#define AIRIQ_NOTIF_CLNT_OBJ  0
#endif /* WL_AIRI_IQ */
...
#if BAND6G
#define BAND_6G(bt)	((bt) == WLC_BAND_6G)
#define WL_NUMCHANSPECS_6G_20   59u
/* No of 40MHZ chan = 29 . (29 * 2 =58 to represent lower and upper) */
#define WL_NUMCHANSPECS_6G_40   58u
/* No of 80MHZ chan = 14 . (29 * 4 =56 to represent 4 subbands in 80MHZ) */
#define WL_NUMCHANSPECS_6G_80   56u
/* No of 160MHZ chan = 7 . (7 * 8 =56 to represent 8 subbands in 160MHZ) */
#define WL_NUMCHANSPECS_6G_160  56u
#else /* BAND6G */
#define BAND_6G(bt)	((void)(bt), 0)
#define WL_NUMCHANSPECS_6G_20	0
#define WL_NUMCHANSPECS_6G_40	0
#define WL_NUMCHANSPECS_6G_80	0
#define WL_NUMCHANSPECS_6G_160	0
#endif /* BAND6G */

#define BAND_5G6G(bt) (BAND_5G(bt) || BAND_6G(bt)) /* TRUE if bandtype is either 5 or 6GHz */

/* Some phy initialization code/data can't be reclaimed in dualband mode */
#if defined(MULTIBAND)
...
/* FIPS support */
#ifdef WLFIPS
#define FIPS_ENAB(wlc) ((wlc)->primary_bsscfg->wsec & FIPS_ENABLED)
#else
...
#define IS_HE_DEV(d) (((d) == BCM43684_CHIP_ID) || \
		      ...
		      ((d) == BCM43684_D11AX2G6G_ID) || \
		      ((d) == BCM43684_D11AX5G6G_ID) || \
		      ((d) == BCM43684_D11AX6G_ID) || \
		      ((d) == BCM43684_D11AX2G5G6G_ID) || \
		      ((d) == EMBEDDED_2x2AX_ID) || \
		      ((d) == EMBEDDED_2x2AX_DEV2G_ID) || \
		      ((d) == EMBEDDED_2x2AX_DEV5G_ID) || \
		      ((d) == EMBEDDED_2x2AX_DEV6G_ID) || \
		      ((d) == EMBEDDED_2x2AX_DEV2G6G_ID) || \
		      ((d) == EMBEDDED_2x2AX_DEV5G6G_ID) || \
		      ((d) == EMBEDDED_2x2AX160_ID) || \
		      ((d) == EMBEDDED_2x2AX160_DEV2G_ID) || \
		      ((d) == EMBEDDED_2x2AX160_DEV5G_ID) || \
		      ((d) == EMBEDDED_2x2AX160_DEV6G_ID) || \
		      ((d) == EMBEDDED_2x2AX160_DEV2G6G_ID) || \
		      ((d) == EMBEDDED_2x2AX160_DEV5G6G_ID) || \
		      ((d) == BCM6715_CHIP_ID) || \
		      ((d) == BCM6715_D11AX_ID) || \
		      ((d) == BCM6715_D11AX2G_ID) || \
		      ((d) == BCM6715_D11AX5G_ID) || \
		      ((d) == BCM6715_D11AX2G6G_ID) || \
		      ((d) == BCM6715_D11AX5G6G_ID) || \
		      ((d) == BCM6715_D11AX6G_ID) || \
		      ((d) == BCM6715_D11AX2G5G6G_ID) || \
		      ((d) == BCM6710_CHIP_ID) || \
		      ((d) == BCM6710_D11AX_ID) || \
		      ((d) == BCM6710_D11AX2G_ID) || \
		      ((d) == BCM6710_D11AX5G_ID) || \
		      ((d) == BCM6710_D11AX2G6G_ID) || \
		      ((d) == BCM6710_D11AX5G6G_ID) || \
		      ((d) == BCM6710_D11AX6G_ID) || \
		      ((d) == BCM43692_D11AX_ID) || \
		      ((d) == BCM43692_D11AX2G_ID) || \
		      ((d) == BCM43692_D11AX5G_ID))

/* Airtime fairness */
#ifndef WLC_ATF_ENABLE_DEFAULT
/* TAF, when enabled, will overrule ATF mode */
#define WLC_ATF_ENABLE_DEFAULT		1
...
#if defined(WL_RX_HANDLER) || defined(WL_TX_STALL)
#define WL_DD_HANDLER
#endif /* WL_RX_HANDLER || WL_TX_STALL */
...
#if BAND6G
/**
 * To aid debug/bringup/interop testing, the #defines below can be commented in.
 */
//#define BAND6G_USING_LEGACY_IES
//#define BAND6G_USING_HT_IES
//#define BAND6G_USING_VHT_IES
#define BAND6G_SUPPORT_6G_BAND_CAPS_IE
#define BAND6G_SUPPORT_SHORT_SSID_IN_PROBES
#endif /* BAND6G */

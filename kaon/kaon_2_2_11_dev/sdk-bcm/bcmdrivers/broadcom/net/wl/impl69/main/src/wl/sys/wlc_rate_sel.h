 ...
 *
 *
 * $Id: wlc_rate_sel.h 793720 2020-12-08 08:32:21Z $
 */
...
extern void wlc_ratesel_upd_itxs(rcb_t *state, rcb_itxs_t *rcb_itxs,
	ratesel_txs_t *rs_txs, tx_status_t *txs, uint16 flags);
extern uint32 wlc_ratesel_get_muboost(rcb_t *state, uint8* num_users);
#if defined(WL11AX)
...
extern bool wlc_ratesel_get_ulrt_sel(rcb_t *state);
extern void wlc_ratesel_restore_txrspec(rcb_t *state);
extern bool wlc_ratesel_is_start_sp(rcb_t *state);

...
FEATURE_BEGIN[common_base]
	...
	M_HOST_FLAGS6	# Host flags to turn on ucode options
	M_REV_L
	M_REV_H
	M_UCODE_FEATURES
	M_ULP_STATUS
...
FEATURE_BEGIN[rev_ge_128]
	...
	MX_OM2SQ4_CNT
	MX_OM2SQ5_CNT
	MX_OMUTXDLMEMTCH_CNT
	M_CSI_STATUS			# Channel State Information Monitor Status
	M_CSI_BLKS			# Channel State Information Monitor Blocks
	M_TXMURTS_CNT
	M_TXTRIGAMPDU_CNT
	M_TXMUBAR_CNT
	M_BSS_BCNPRS_PWR_BLK		# Base address of txpwr backoff for bcn/prs per BSS
	M_PPR_BLK
	M_MAX_TXPWR
	M_BRDLMT_BLK
	M_RULMT_BLK

 ...
 *
 * $Id: phy_type_chanmgr.h 792280 2020-10-22 01:44:37Z $
 */
...
typedef void (*phy_type_chanmgr_smth_per_nss_SUTxbf_fn_t)(phy_type_chanmgr_ctx_t *ctx,
	uint8 uint_val);
...
typedef void (*phy_type_chanmgr_sr_enable_fn_t)(phy_info_t *pi, uint8 set_val);
typedef void (*phy_type_chanmgr_srg_bssColor_fn_t)(phy_info_t *pi, uint8 set_val, uint16 BM0,
		uint16 BM1, uint16 BM2, uint16 BM3);
...
typedef struct {
	...
	/* smth_per_nss_SUTxbf */
	phy_type_chanmgr_smth_per_nss_SUTxbf_fn_t smth_per_nss_SUTxbf;
	...
	/* set Spatial Reuse */
	phy_type_chanmgr_sr_enable_fn_t sr_enable;
	/* set SRG BSS Color */
	phy_type_chanmgr_srg_bssColor_fn_t srg_bssColor;
	/* keep PAD online all the time */
	phy_type_chanmgr_pad_online_enable_fn_t pad_online_enable;
	/* force dc cal */
	phy_type_chanmgr_dccal_t dccal_force;
	/* set stf chain */

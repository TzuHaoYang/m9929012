 ...
 */
#define OCE_ASS_REJ_RSSI_INVALID		(0)
...
#define OCE_MEDIUM_BUSY		0U
#define OCE_MEDIUM_IDLE_7000US	7000U
...
uint16 wlc_oce_if_valid_assoc(wlc_oce_info_t *oce, wlc_bsscfg_t *bsscfg, int8 *rssi,
...
void wlc_oce_scan_complete_cb(void *ctx, int status, wlc_bsscfg_t *bsscfg);
extern bool wlc_oce_bsscfg_is_enabled(wlc_info_t *wlc, wlc_bsscfg_t *cfg);
void wlc_oce_update_static_ap_chrep(wlc_oce_info_t* oce, wlc_bsscfg_t *bsscfg, chanspec_t chspec);
extern void wlc_oce_reset_ssid_list(wlc_bsscfg_t *bsscfg);
extern void wlc_oce_set_sssid_for_rnr_completeness_attr(wlc_bsscfg_t *bsscfg, uint32 short_ssid);
extern int wlc_oce_send_fd_frame(wlc_oce_info_t *oce, wlc_bsscfg_t *bsscfg);
extern int wlc_oce_write_fd_info_field(wlc_oce_info_t *oce, wlc_bsscfg_t *bsscfg,
	uint8 *buf, uint16 buf_len);
extern void wlc_oce_detect_11b_environment(wlc_oce_info_t *oce);
#endif	/* _wlc_oce_h_ */

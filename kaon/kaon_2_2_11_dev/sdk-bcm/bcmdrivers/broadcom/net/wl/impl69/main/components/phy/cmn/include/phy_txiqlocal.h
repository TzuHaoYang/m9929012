 ...
 *
 * $Id: phy_txiqlocal.h 791888 2020-10-13 04:07:17Z $
 */
...
int phy_txiqlocal_get_target_tssi(phy_info_t *pi, int32 *target_tssi);
int phy_txiqlocal_set_target_tssi(phy_info_t *pi, int32 target_tssi);
int phy_txiqlocal_get_tssi_search_enable(phy_info_t *pi, int32 *tssi_search_en);
int phy_txiqlocal_set_tssi_search_enable(phy_info_t *pi, int32 tssi_search_en);
#endif // endif

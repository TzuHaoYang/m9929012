 ...
 *
 * $Id: wlc_airtime.h 791430 2020-09-25 15:39:00Z $
 *
 */
...
#define WLC_AIRTIME_PERC		3
#define WLC_AIRTIME_DONGLE		4
 ...
 * Returns time is microseconds.
 */
extern BCMFASTPATH uint wlc_airtime_payload_time_us_rate(uint32 flg,
	uint32 rate, uint size_in_bytes);

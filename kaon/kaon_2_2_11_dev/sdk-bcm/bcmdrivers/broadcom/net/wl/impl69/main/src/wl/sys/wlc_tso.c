 ...
 *
 * $Id: wlc_tso.c 791560 2020-10-01 08:23:54Z $
 */
...
#define OFFSET_INCR(a) \
	...
	if (*maclow & D11AC_TXC_HDR_FMT_SHORT) {
		tso->flag[2] |= TOE_F2_TXD_HEAD_SHORT;
		OFFSET_INCR(D11_TXH_SHORT_LEN(wlc));
	} else {
		OFFSET_INCR(D11_TXH_LEN_EX(wlc));
	}

 ...
 *
 * $Id: phy_ac_radar.c 792577 2020-10-30 02:48:55Z $
 */
...
BCMATTACHFN(phy_radar_init_st)(phy_info_t *pi, phy_radar_st_t *st)
{
	...
	/* max_deltat[15:1] = interval for newJPN extended pulse combination  */
	/* max_deltat[0] = enable min_pulses adjustment for short pulses */
	st->rparams.radar_args.max_deltat = 3800; /* 0x0ed8 */

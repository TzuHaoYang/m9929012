...
wlc_airiq_phy_init(airiq_info_t *airiqh)
{
	...
	case 131:
		...
		/*init vasip addresses*/
		airiqh->svmp_fft_data_addr= SVMP_47622_FFT_DATA_ADDR;
		airiqh->svmp_status_addr= SVMP_47622_STATUS_ADDR;
		airiqh->svmp_smpl_ctrl_addr= SVMP_47622_SMPL_CTRL_ADDR;
		airiqh->svmp_smpl_enable_addr= SVMP_47622_SMPL_ENABLE_ADDR;
		airiqh->svmp_smpl_interval_addr= SVMP_47622_SMPL_INTERVAL_ADDR;
		airiqh->svmp_header_addr= SVMP_47622_HEADER_ADDR;
		airiqh->svmp_smpl_size_addr= SVMP_47622_SMPL_SIZE_ADDR;
		airiqh->svmp_smpl_mode_addr= SVMP_47622_SMPL_MODE_ADDR;
		airiqh->svmp_smpl_core_addr= SVMP_47622_SMPL_CORE_ADDR;
		airiqh->svmp_smpl_gain_addr= SVMP_47622_SMPL_GAIN_ADDR;
		airiqh->svmp_header_ext_addr= SVMP_47622_HEADER_EXT_ADDR;
		airiqh->svmp_smpl_timestamp_addr_l= SVMP_47622_SMPL_TIMESTAMP_ADDR_L ;
		airiqh->svmp_smpl_timestamp_addr_h= SVMP_47622_SMPL_TIMESTAMP_ADDR_H;
		airiqh->svmp_smpl_seq_num_addr= SVMP_47622_SMPL_SEQ_NUM_ADDR;
		airiqh->svmp_smpl_chanspec_addr= SVMP_47622_SMPL_CHANSPEC_ADDR;
		airiqh->svmp_smpl_chanspec_3x3_addr= SVMP_47622_SMPL_CHANSPEC_3X3_ADDR;
		airiqh->svmp_smpl_coex_gpio_mask_addr= SVMP_47622_SMPL_COEX_GPIO_MASK_ADDR;
		break;
	default:
		memcpy(&airiqh->gaintbl_24ghz, &airiq_gaintbl_rev65_24ghz,
				sizeof(airiqh->gaintbl_24ghz));

 ...
 *
 * $Id: wlc_phy_shim.h 793797 2020-12-10 06:31:26Z $
 */
...
extern void wlapi_bmac_write_ihr(wlc_phy_shim_info_t *physhim, uint offset, uint16 v);
extern uint16 wlapi_bmac_read_ihr(wlc_phy_shim_info_t *physhim, uint offset);
...
extern void wlapi_bmac_upd_ifs(wlc_phy_shim_info_t *physhim);
#ifdef STA
...
#define SVMPADDR2VC(addr)      (((addr)>>4))
#define SVMPADDR2MEMIDX(addr)  (((addr)>>15))
#define SVMPADDR2MEMADDR(addr) ((((addr)&0x7fff)>>1))
extern uint32 wlapi_get_svmp_addr_txbf_ppr_tbl(wlc_phy_shim_info_t *physhim);
extern uint32 wlapi_get_svmp_addr_m2v_buf(wlc_phy_shim_info_t *physhim, int id);
extern uint32 wlapi_get_svmp_addr_bfd_buffer(wlc_phy_shim_info_t *physhim, int id);
extern uint32 wlapi_get_svmp_addr_csi_rpt(wlc_phy_shim_info_t *physhim, int id);
extern uint32 wlapi_get_svmp_addr_mu_output(wlc_phy_shim_info_t *physhim, int id);
extern uint32 wlapi_get_svmp_addr_txv_decompressed_report(wlc_phy_shim_info_t *physhim);
extern uint32 wlapi_get_svmp_addr_imbf_rpt(wlc_phy_shim_info_t *physhim);
extern uint32 wlapi_get_svmp_addr_sch_phybw(wlc_phy_shim_info_t *physhim);
extern uint16 wlapi_get_svmp_size_txv_decompressed_report(wlc_phy_shim_info_t *physhim);

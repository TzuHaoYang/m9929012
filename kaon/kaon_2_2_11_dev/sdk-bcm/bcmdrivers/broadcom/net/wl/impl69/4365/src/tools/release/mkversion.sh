...
#        AKASHI_REL_5_110_25
#
#  # $Id: mkversion.sh 708017 2017-06-29 14:11:45Z $
#
...
SVNURL='$HeadURL: svn://bcawlan-svnfast.sj.broadcom.net/svn/bcawlan/proj/tags/EAGLE/EAGLE_REL_10_10_131_76/src/tools/release/mkversion.sh $'
...
if echo "$SVNURL" | egrep -vq 'HeadURL.*mkversion.sh|http://.*/DEPS'; then
	[ -n "$VERBOSE" ] && \

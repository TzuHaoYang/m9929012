 ...
 *
 * $Id: wlc_dump.c 791660 2020-10-06 14:58:48Z $
 */
...
#include <wlc_dump.h>
	...
	defined(BCM_DNGDMP) || defined(DNG_DBGDUMP)
...
#define WLC_DUMP_NUM_REGS 13 /* TODO: merge all these defines to a common release dump define ? */
#else
#define WLC_DUMP_NUM_REGS 6
#endif // endif

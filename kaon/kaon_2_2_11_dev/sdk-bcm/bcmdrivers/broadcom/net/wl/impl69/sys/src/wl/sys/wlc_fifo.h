...
/* public APIs. */
extern uint8 wlc_fifo_index_get(wlc_fifo_info_t *fifo_info, struct scb *scb, uint ac);
extern uint8 wlc_fifo_index_peek(wlc_fifo_info_t *fifo_info, struct scb *scb, uint ac);
...
extern void wlc_fifo_free_all(wlc_fifo_info_t *fifo_info, struct scb *scb);
extern void wlc_fifo_free(wlc_fifo_info_t *fifo_info, struct scb *scb, int fifo_index);
...
extern bool wlc_fifo_is_ulofdma(wlc_fifo_info_t *fifo_info, struct scb *scb);

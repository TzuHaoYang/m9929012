...
//hong for home/svn/bcm-wifi-mesh/trunk/SDK_5.02L.07p1_KAON
#define BOARD_IOCTL_USER_GET_CUSTOMID           _IOWR(BOARD_IOCTL_MAGIC, 70, BOARD_IOCTL_PARMS)
/*
 * by hogi
 * Change the CFE nvram area to be writable.
 */
#define BOARD_IOCTL_USER_FLASH_WR               _IOWR(BOARD_IOCTL_MAGIC, 71, BOARD_IOCTL_PARMS)

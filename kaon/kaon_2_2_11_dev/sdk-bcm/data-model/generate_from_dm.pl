...
elsif ($ARGV[0] eq "oidinfo" || $ARGV[0] eq "oidinfo2")
{
    ...
    $outputFileRef = open_filehandle_for_output("$build_dir/userspace/private/libs/cms_core/$outputFileName");
...
elsif ($ARGV[0] eq "mdm" || $ARGV[0] eq "mdm2")
{
    ...
    my $basedir = $build_dir . "/userspace/private/libs/$mdm_dir";
...
elsif ($ARGV[0] eq "prototypes")
{
    ...
    $fileRef1 = open_filehandle_for_output("$build_dir/userspace/private/libs/cms_core/rcl.h");
    $fileRef2 = open_filehandle_for_output("$build_dir/userspace/private/libs/cms_core/stl.h");
...
elsif ($ARGV[0] eq "skeletons")
{
    ...
    $inputFileRef = open_filehandle_for_input("$build_dir/data-model/$inputFile");
    $fileRef1 = open_filehandle_for_output("$build_dir/userspace/private/libs/cms_core/linux/rcl_skel.c");
    $fileRef2 = open_filehandle_for_output("$build_dir/userspace/private/libs/cms_core/linux/stl_skel.c");

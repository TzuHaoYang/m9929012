...
enum bp_id {
  ...
  bp_usPcmClk,
  bp_usPcmFs,
  bp_usI2sSdata,    //TX slave data
  bp_usI2sTxSdata=bp_usI2sSdata,    //TX slave data
  bp_usI2sRxSdata,  //RX slave data new added 
  bp_usI2sSclk,
  bp_usI2sMclk,
  bp_usI2sLrck,
  bp_usGpioTxDis0,
  ...
  bp_usGpioOpticalModuleFixup, /* obsolete; left for backward compatibility only */

...
SDK_INCLUDES += -I$(BUILD_DIR)/userspace/private/include/
SDK_INCLUDES += -I$(BUILD_DIR)/userspace/public/include/
SDK_INCLUDES += -I$(BUILD_DIR)/userspace/public/include/linux/
...
include $(BUILD_DIR)/cabuildflags.make
